...
import fr.utbm.set.io.filefilter.TextFileFilter;
...
/**
 * Window for entering the OBR Manipulation parameters.
 * 
 ...
 */
public class OBRParameterDialog extends JOkCancelBtDialog implements ListSelectionListener, DocumentListener {
	...
	private static final String ACTION_BROWSE_OBR_FILE = "BROWSE_TREE_FILE"; //$NON-NLS-1$
	 ...
	 * @param parent
	 */
	public OBRParameterDialog(Component parent) {
		super(parent, "OBR Manipulation Parameters"); //$NON-NLS-1$
		setModal(true);
		...
		c.gridx = 0;
		c.gridy = 0;
		label = new JLabel("Output OBR file:"); //$NON-NLS-1$
		...
		this.browseTreeFile.setActionCommand(ACTION_BROWSE_OBR_FILE);
	...
	public void actionPerformed(ActionEvent e) {
		...
		} else if (ACTION_BROWSE_OBR_FILE.equals(cmd)) {
			File file = FrameUtil.getOpenFile(this, "Select OBR file", //$NON-NLS-1$
					new File(this.model3dFile.getText()), new TextFileFilter());
			if (file != null) {
