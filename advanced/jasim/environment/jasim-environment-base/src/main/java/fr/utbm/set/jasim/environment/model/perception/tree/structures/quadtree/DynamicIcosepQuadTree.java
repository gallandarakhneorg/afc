 ...
 */
public abstract class DynamicIcosepQuadTree<
...
extends AbstractIcosepQuadTree<CB,DB,D,NB,N,T>
implements DynamicPerceptionTree<CB,DB,D,NB,N,T,M> {

	private static final long serialVersionUID = 5810088010114720483L;
	 ...
	 */
	public DynamicIcosepQuadTree(M manipulator) {
