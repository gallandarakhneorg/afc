 ...
 */
public abstract class DynamicIcosepQuadTreeNode<
					CB extends CombinableBounds<? super CB,?,?,?>,
					DB extends CB,
					D extends MobileEntity<DB>,
					NB extends CB,
					N extends DynamicIcosepQuadTreeNode<CB,DB,D,NB,N,T,M>,
					T extends DynamicIcosepQuadTree<CB,DB,D,NB,N,T,M>,
...
implements DynamicPerceptionTreeNode<DB,D,NB,N> {
	...
	private static final long serialVersionUID = -4293089515284472049L;
	 ...
	 */
	public DynamicIcosepQuadTreeNode(T tree, double cutX, double cutY) {
	 ...
	 */
	public DynamicIcosepQuadTreeNode(T tree, double cutX, double cutY, List<D> data) {
	...
	public int classifies(DB box) {
		return QuadTreeUtil.classifiesBoxWithIcosep(getCutLineX(), getCutLineY(), box.getLower(), box.getUpper());
	}
