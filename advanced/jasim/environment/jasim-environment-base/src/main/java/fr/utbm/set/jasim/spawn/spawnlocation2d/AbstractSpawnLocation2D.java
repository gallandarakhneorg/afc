 ...
 */
public abstract class AbstractSpawnLocation2D
extends AbstractSpawnLocation<EuclidianPoint2D,Direction2D,DirectionConstraint2D>
implements GroundBasedSpawnLocation {
	 ...
	 */
	public AbstractSpawnLocation2D(UUID identifier, String name, EuclidianPoint2D spawnerPosition, DirectionConstraint2D direction, double startDate, double endDate) {
