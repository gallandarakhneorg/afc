 ...
 */
public class NonIcosepBinaryPartitionFieldFactory implements PartitionFieldFactory<BinaryPartitionField> {

	/** Singleton.
	 */
	public static final NonIcosepBinaryPartitionFieldFactory SINGLETON = new NonIcosepBinaryPartitionFieldFactory();
	
	private NonIcosepBinaryPartitionFieldFactory() {
		//
	}
	...
	public BinaryPartitionField newPartitionField(int nodeIndex, Bounds<?,?,?> bounds, EuclidianPoint referencePoint) {
		...
		return new NonIcosepField(ref, coordIdx);
	}
	 ...
	 * @mavenartifactid $ArtifactId$
	 */
	private class NonIcosepField implements BinaryPartitionField {
		 ...
		 */
		public NonIcosepField(double coord, int coordinateIndex) {
			this.x = coord;
