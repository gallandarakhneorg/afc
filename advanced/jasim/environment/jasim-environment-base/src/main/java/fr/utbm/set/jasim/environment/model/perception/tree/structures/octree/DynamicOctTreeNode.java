 ...
 */
public abstract class DynamicOctTreeNode<
					CB extends CombinableBounds<? super CB,?,?,?>,
					DB extends CB,
					D extends MobileEntity<DB>,
					NB extends CB,
					N extends DynamicOctTreeNode<CB,DB,D,NB,N,T,M>,
					T extends DynamicOctTree<CB,DB,D,NB,N,T,M>,
					M extends TreeManipulator<D,N,T>>
extends AbstractOctTreeNode<CB,DB,D,NB,N,T>
implements DynamicPerceptionTreeNode<DB,D,NB,N> {

	private static final long serialVersionUID = -7923480757441186529L;
	 ...
	 */
	public DynamicOctTreeNode(T tree, double cutX, double cutY, double cutZ) {
	 ...
	 */
	public DynamicOctTreeNode(T tree, double cutX, double cutY, double cutZ, List<D> data) {
