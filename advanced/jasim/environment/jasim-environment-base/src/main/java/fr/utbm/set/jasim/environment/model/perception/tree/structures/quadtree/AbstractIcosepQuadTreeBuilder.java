 ...
 */
public abstract class AbstractIcosepQuadTreeBuilder<
...
extends AbstractPerceptionTreeBuilder<CB,DB,D,T,NB,N,QuadryPartitionField> {
	 ...
	 */
	public AbstractIcosepQuadTreeBuilder(int splittingCount, PartitionPolicy partitionHeuristic) {
		super(splittingCount, partitionHeuristic);
		assert(partitionHeuristic!=null);
		setPartitionFieldFactory(IcosepQuadryPartitionFieldFactory.SINGLETON);
	}
