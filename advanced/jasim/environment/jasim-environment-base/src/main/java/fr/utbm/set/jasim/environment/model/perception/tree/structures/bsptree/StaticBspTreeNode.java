 ...
 */
public abstract class StaticBspTreeNode<
					CB extends CombinableBounds<? super CB,?,?,?>,
					DB extends CB,
					D extends WorldEntity<DB>,
					NB extends CB,
					N extends StaticBspTreeNode<CB,DB,D,NB,N,T>,
					T extends StaticBspTree<CB,DB,D,NB,N,T>>
...
implements StaticPerceptionTreeNode<D,NB,N> {
	 ...
	 */
	public StaticBspTreeNode(T tree, double cutValue, int cutCoordinateIndex) {
	 ...
	 */
	public StaticBspTreeNode(T tree, double cutValue, int cutCoordinateIndex, List<D> data) {
