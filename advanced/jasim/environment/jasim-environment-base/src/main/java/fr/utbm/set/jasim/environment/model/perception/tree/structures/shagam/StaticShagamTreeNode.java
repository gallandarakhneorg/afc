 ...
 */
public abstract class StaticShagamTreeNode<
...
implements StaticPerceptionTreeNode<D,NB,N> {
	...
	private static final long serialVersionUID = 8858454195630285324L;
	 ...
	 */
	public StaticShagamTreeNode(T tree, double cutX, double cutY, double cutZ) {
	 ...
	 */
	public StaticShagamTreeNode(T tree, double cutX, double cutY, double cutZ, List<D> data) {
