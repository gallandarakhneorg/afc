 ...
 */
public abstract class DynamicShagamTreeNode<
					CB extends CombinableBounds<? super CB,?,?,?>,
					DB extends CB,
					D extends MobileEntity<DB>,
					NB extends CB,
					N extends DynamicShagamTreeNode<CB,DB,D,NB,N,T,M>,
					T extends DynamicShagamTree<CB,DB,D,NB,N,T,M>,
					M extends TreeManipulator<D,N,T>>
extends AbstractShagamTreeNode<CB,DB,D,NB,N,T>
implements DynamicPerceptionTreeNode<DB,D,NB,N> {

	private static final long serialVersionUID = 3894422416196187877L;
	 ...
	 */
	public DynamicShagamTreeNode(T tree, double cutX, double cutY, double cutZ) {
	 ...
	 */
	public DynamicShagamTreeNode(T tree, double cutX, double cutY, double cutZ, List<D> data) {
