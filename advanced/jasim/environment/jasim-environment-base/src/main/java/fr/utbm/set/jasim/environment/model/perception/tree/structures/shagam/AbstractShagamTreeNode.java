...
import fr.utbm.set.tree.node.NaryTreeNode;
 ...
 */
abstract class AbstractShagamTreeNode<
						CB extends CombinableBounds<? super CB,?,?,?>,
						DB extends CB,
						D extends WorldEntity<DB>,
						NB extends CB,
						N extends AbstractShagamTreeNode<CB,DB,D,NB,N,T>,
						T extends AbstractShagamTree<CB,DB,D,NB,N,T>>
extends NaryTreeNode<D,N>
implements PerceptionTreeNode<D,NB,N> {

	private static final long serialVersionUID = -8481178467656983517L;
	 ...
	 */
	public AbstractShagamTreeNode(T tree, double cutX, double cutY, double cutZ) {
	 ...
	 */
	public AbstractShagamTreeNode(T tree, double cutX, double cutY, double cutZ, List<D> data) {
	 ...
	 */
	public final boolean setChildAt(ShagamTreeZone zone, N newChild) {
	 ...
	 */
	@Override
	public boolean setChildAt(int index, N newChild) {
		if (super.setChildAt(index, newChild)) {
			// Update the bounding box
			updateBoundsAndNodeOwners(true,false);
			return true;
		}
