 ...
 */
public abstract class StaticQuadTreeNode<
...
implements StaticPerceptionTreeNode<D,NB,N> {
	 ...
	 */
	public StaticQuadTreeNode(T tree, double cutX, double cutY) {
	 ...
	 */
	public StaticQuadTreeNode(T tree, double cutX, double cutY, List<D> data) {
