...
import fr.utbm.set.jasim.environment.model.perception.tree.structures.octree.IcosepOctyPartitionFieldFactory;
 ...
 */
public abstract class AbstractShagamTreeBuilder<
...
extends AbstractPerceptionTreeBuilder<CB,DB,D,T,NB,N,OctyPartitionField> {
	 ...
	 */
	public AbstractShagamTreeBuilder(int splittingCount, PartitionPolicy partitionHeuristic) {
		super(splittingCount, partitionHeuristic);
		assert(partitionHeuristic!=null);
		setPartitionFieldFactory(IcosepOctyPartitionFieldFactory.SINGLETON);
	}
