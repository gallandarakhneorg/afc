...
import fr.utbm.set.tree.node.IcosepQuadTreeNode;
 ...
 */
abstract class AbstractIcosepQuadTreeNode<
						CB extends CombinableBounds<? super CB,?,?,?>,
						DB extends CB,
						D extends WorldEntity<DB>,
						NB extends CB,
						N extends AbstractIcosepQuadTreeNode<CB,DB,D,NB,N,T>,
						T extends AbstractIcosepQuadTree<CB,DB,D,NB,N,T>>
extends IcosepQuadTreeNode<D,N>
implements PerceptionTreeNode<D,NB,N> {
	 ...
	 */
	public AbstractIcosepQuadTreeNode(T tree, double cutX, double cutY) {
	 ...
	 */
	public AbstractIcosepQuadTreeNode(T tree, double cutX, double cutY, List<D> data) {
	...
	public boolean isValid() {
		if (this.boundingBox!=null && this.boundingBox.isInit())
			return !isEmpty();
		return isEmpty();
	}
