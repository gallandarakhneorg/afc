 ...
 */
public abstract class AbstractIcosepBspTreeBuilder<
...
extends AbstractPerceptionTreeBuilder<CB,DB,D,T,NB,N,BinaryPartitionField> {
	 ...
	 */
	public AbstractIcosepBspTreeBuilder(int splittingCount, PartitionPolicy partitionHeuristic) {
		super(splittingCount, partitionHeuristic);
		assert(partitionHeuristic!=null);
		setPartitionFieldFactory(IcosepBinaryPartitionFieldFactory.SINGLETON);
	}
