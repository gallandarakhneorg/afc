...
import fr.utbm.set.tree.node.IcosepOctTreeNode;
 ...
 */
abstract class AbstractIcosepOctTreeNode<
						CB extends CombinableBounds<? super CB,?,?,?>,
						DB extends CB,
						D extends WorldEntity<DB>,
						NB extends CB,
						N extends AbstractIcosepOctTreeNode<CB,DB,D,NB,N,T>,
						T extends AbstractIcosepOctTree<CB,DB,D,NB,N,T>>
extends IcosepOctTreeNode<D,N>
implements PerceptionTreeNode<D,NB,N> {

	private static final long serialVersionUID = -3477117656507603522L;
	 ...
	 */
	public AbstractIcosepOctTreeNode(T tree, double cutX, double cutY, double cutZ) {
	 ...
	 */
	public AbstractIcosepOctTreeNode(T tree, double cutX, double cutY, double cutZ, List<D> data) {
