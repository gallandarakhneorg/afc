...
import fr.utbm.set.tree.node.BinaryTreeNode;
 ...
 */
abstract class AbstractBspTreeNode<
...
implements PerceptionTreeNode<D,NB,N> {
	...
	private static final long serialVersionUID = -4541376178446609437L;
	 ...
	 */
	public AbstractBspTreeNode(T tree, double cutValue, int cutCoordinateIndex) {
	 ...
	 */
	public AbstractBspTreeNode(T tree, double cutValue, int cutCoordinateIndex, List<D> data) {
