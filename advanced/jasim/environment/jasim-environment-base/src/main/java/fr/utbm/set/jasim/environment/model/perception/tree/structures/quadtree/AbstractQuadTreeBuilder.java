 ...
 */
public abstract class AbstractQuadTreeBuilder<
...
extends AbstractPerceptionTreeBuilder<CB,DB,D,T,NB,N,QuadryPartitionField> {
	 ...
	 */
	public AbstractQuadTreeBuilder(int splittingCount, PartitionPolicy partitionHeuristic) {
		super(splittingCount, partitionHeuristic);
		assert(partitionHeuristic!=null);
		setPartitionFieldFactory(NonIcosepQuadryPartitionFieldFactory.SINGLETON);
	}
