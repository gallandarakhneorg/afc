 ...
 */
public class WayPoint3D extends WayPoint {
	 ...
	 */
	public WayPoint3D(double x, double y, double z, double tx, double ty, double tz, double desiredTime, double velocity) {
	 ...
	 * when it reach this waypoint.
	 */
	public WayPoint3D(double x, double y, double z, double tx, double ty, double tz, double velocity) {
		super(velocity);
		this.x = x;
		this.y = y;
		this.z = z;
