 ...
 */
public abstract class DynamicIcosepBspTreeNode<
					CB extends CombinableBounds<? super CB,?,?,?>,
					DB extends CB,
					D extends MobileEntity<DB>,
					NB extends CB,
					N extends DynamicIcosepBspTreeNode<CB,DB,D,NB,N,T,M>,
					T extends DynamicIcosepBspTree<CB,DB,D,NB,N,T,M>,
...
implements DynamicPerceptionTreeNode<DB,D,NB,N> {
	 ...
	 */
	public DynamicIcosepBspTreeNode(T tree, double cutValue, int cutCoordinateIndex) {
	 ...
	 */
	public DynamicIcosepBspTreeNode(T tree, double cutValue, int cutCoordinateIndex, List<D> data) {
