 ...
 */
public class WayPoint3DTest extends AbstractExtendedTestCase {
	...
	public void setUp() throws Exception {
		...
		this.hotPoint = new WayPoint3D(this.x,this.y,this.z,
				this.tx,this.ty,this.tz,this.velocity,this.time);
	}
