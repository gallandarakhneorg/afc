 ...
 */
public class SpawnArea2DTest extends AbstractSpawnLocationTest<SpawnArea2D> {
	...
	@Override
	protected SpawnArea2D createSpawner(double startDate, double endDate) {
		return new SpawnArea2D(
				UUID.randomUUID(),
				randomString(),
	...
	public void testGetReferencePoint() {
		assertEquals(new Point2d(this.position.getMinX(),this.position.getMinY()),
				this.point.getReferencePoint());
	}
