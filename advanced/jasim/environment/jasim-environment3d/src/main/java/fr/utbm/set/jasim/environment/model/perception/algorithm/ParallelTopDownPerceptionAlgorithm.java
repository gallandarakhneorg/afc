...
/**
 * This perception algorithm is going top-down through
 * the perceptions trees for each agents, but it
 ...
 */
public class ParallelTopDownPerceptionAlgorithm<SB extends CombinableBounds3D, MB extends CombinableBounds3D>
extends AbstractParallelPerceptionAlgorithm<SB,MB> {

	/**
	 * @param threadCount is the count of thread used to compute perceptions.
	 */
	public ParallelTopDownPerceptionAlgorithm(int threadCount) {
		super(threadCount);
	}
