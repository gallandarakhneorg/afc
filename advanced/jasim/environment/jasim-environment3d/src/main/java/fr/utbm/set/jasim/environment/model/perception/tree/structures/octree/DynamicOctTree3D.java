 ...
 */
public class DynamicOctTree3D<DB extends CombinableBounds3D>
extends DynamicOctTree<CombinableBounds3D,
					   DB,
					   MobileEntity3D<DB>,
					   AlignedBoundingBox,
	...
	private static final long serialVersionUID = -1987452651435796914L;

	/** Empty tree.
	 * 
	 * @param manipulator is the manipulator to use.
	 */
	public DynamicOctTree3D(OctTreeManipulator3D<DB> manipulator) {
		super(manipulator);
