 ...
 */
public class DynamicIcosepBspTreeBuilder3D<DB extends CombinableBounds3D> 
extends AbstractIcosepBspTreeBuilder<CombinableBounds3D,
	 ...
	 */
	public DynamicIcosepBspTreeBuilder3D(int splittingCount, PartitionPolicy partitionHeuristic) {
	 ...
	 */
	@Override
	protected DynamicIcosepBspTree3D<DB> createEmptyTree(AlignedBoundingBox universeBounds) {
		return new DynamicIcosepBspTree3D<DB>(new IcosepBspTreeManipulator3D<DB>(
				getSplittingCount(),
	 ...
	 */
	@Override
	protected DynamicIcosepBspTreeNode3D<DB> createTreeNode(
			int index,
