 ...
 */
public class StaticOctTreeBuilder3D<DB extends CombinableBounds3D> 
extends AbstractOctTreeBuilder<CombinableBounds3D,
	 ...
	 */
	public StaticOctTreeBuilder3D(int splittingCount, PartitionPolicy partitionHeuristic) {
	 ...
	 */
	@Override
	protected StaticOctTree3D<DB> createEmptyTree(AlignedBoundingBox universBounds) {
		return new StaticOctTree3D<DB>();
	}
