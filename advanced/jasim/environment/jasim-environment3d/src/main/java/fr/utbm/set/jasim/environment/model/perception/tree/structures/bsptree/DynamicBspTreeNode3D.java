 ...
 */
public class DynamicBspTreeNode3D<DB extends CombinableBounds3D>
extends DynamicBspTreeNode<CombinableBounds3D,
						   DB,
						   MobileEntity3D<DB>,
						   AlignedBoundingBox,
	...
	private static final long serialVersionUID = -843819060742303725L;
	 ...
	 */
	public DynamicBspTreeNode3D(DynamicBspTree3D<DB> tree, double cutValue, int cutCoordinateIndex) {
	 ...
	 */
	public DynamicBspTreeNode3D(DynamicBspTree3D<DB> tree, double cutValue, int cutCoordinateIndex, List<MobileEntity3D<DB>> data) {
