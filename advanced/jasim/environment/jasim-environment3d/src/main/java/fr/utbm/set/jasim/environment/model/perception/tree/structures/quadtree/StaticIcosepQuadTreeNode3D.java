 ...
 */
public class StaticIcosepQuadTreeNode3D<DB extends CombinableBounds3D>
extends StaticIcosepQuadTreeNode<CombinableBounds3D,
								 DB,
								 Entity3D<DB>,
								 AlignedBoundingBox,
	...
	private static final long serialVersionUID = 4706888572156532673L;
	 ...
	 */
	public StaticIcosepQuadTreeNode3D(StaticIcosepQuadTree3D<DB> tree, double cutX, double cutY) {
	 ...
	 */
	public StaticIcosepQuadTreeNode3D(StaticIcosepQuadTree3D<DB> tree, double cutX, double cutY, List<Entity3D<DB>> data) {
