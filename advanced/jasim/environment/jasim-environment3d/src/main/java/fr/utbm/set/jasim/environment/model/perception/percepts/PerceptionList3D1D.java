 ...
 */
public class PerceptionList3D1D<SB extends CombinableBounds3D, MB extends CombinableBounds3D>
extends PerceptionList3D<SB,MB,Perception1D> {
	
	/**
	 */
	public PerceptionList3D1D() {
		//
	}

	@Override
	protected Perception1D createPerception(CullingResult<? extends Entity3D<? extends CombinableBounds3D>> result) {
		return null;
	}
