 ...
 */
public class DynamicIcosepOctTreeNode3D<DB extends CombinableBounds3D>
extends DynamicIcosepOctTreeNode<CombinableBounds3D,
								 DB,
								 MobileEntity3D<DB>,
								 AlignedBoundingBox,
	 ...
	 */
	public DynamicIcosepOctTreeNode3D(DynamicIcosepOctTree3D<DB> tree, double cutX, double cutY, double cutZ) {
	 ...
	 */
	public DynamicIcosepOctTreeNode3D(DynamicIcosepOctTree3D<DB> tree, double cutX, double cutY, double cutZ, List<MobileEntity3D<DB>> data) {
