 ...
 */
public class PerceptionList3D2DTest extends TestCase {

	private PerceptionList3D2D<AlignedBoundingBox,AlignedBoundingBox> tested;
	...
	protected void setUp() throws Exception {
		super.setUp();
		this.tested = new PerceptionList3D2D<AlignedBoundingBox,AlignedBoundingBox>();
	}
	...
	public void testIsSupportedPerceptionType() {
		...
		assertTrue(this.tested.isSupportedPerceptionType(Perception2D.class));
		assertFalse(this.tested.isSupportedPerceptionType(Perception3D.class));
		
		assertTrue(this.tested.isSupportedPerceptionType(Perception3D2D.class));
