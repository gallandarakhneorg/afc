 ...
 */
public class PerceptionList3D1D5Test extends TestCase {

	private PerceptionList3D1D5<AlignedBoundingBox,AlignedBoundingBox> tested;
	...
	protected void setUp() throws Exception {
		super.setUp();
		this.tested = new PerceptionList3D1D5<AlignedBoundingBox,AlignedBoundingBox>();
	}
	...
	public void testIsSupportedPerceptionType() {
		...
		assertTrue(this.tested.isSupportedPerceptionType(Perception1D5.class));
