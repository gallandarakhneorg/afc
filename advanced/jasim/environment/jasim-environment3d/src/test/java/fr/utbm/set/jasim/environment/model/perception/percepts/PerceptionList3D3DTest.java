 ...
 */
public class PerceptionList3D3DTest extends TestCase {

	private PerceptionList3D3D<AlignedBoundingBox,AlignedBoundingBox> tested;
	...
	protected void setUp() throws Exception {
		super.setUp();
		this.tested = new PerceptionList3D3D<AlignedBoundingBox,AlignedBoundingBox>();
	}
	...
	public void testIsSupportedPerceptionType() {
		...
		assertFalse(this.tested.isSupportedPerceptionType(Perception1D.class));
		...
		assertTrue(this.tested.isSupportedPerceptionType(Perception3D.class));
		
		assertFalse(this.tested.isSupportedPerceptionType(Perception3D2D.class));
		assertTrue(this.tested.isSupportedPerceptionType(Perception3D3D.class));
	}
