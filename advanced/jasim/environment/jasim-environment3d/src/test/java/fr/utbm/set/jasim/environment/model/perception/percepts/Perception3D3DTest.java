 ...
 */
public class Perception3D3DTest extends AbstractTestCase {

	private UUID frustum;
	private Perception3D3D tested;
	...
	protected void setUp() throws Exception {
		...
		this.tested = new Perception3D3D(
				this.frustum,
				this.type,
				this.entity);
	}
	...
	public void testGetPerceivedObjectPosition() {
		assertEpsilonEquals(this.entity.getPosition3D(), this.tested.getPerceivedObjectPosition());
	}
