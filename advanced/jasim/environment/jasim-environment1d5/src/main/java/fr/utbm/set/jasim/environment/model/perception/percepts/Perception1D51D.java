...
/** This class describes a 1D mapping of a 1.5D perception inside a situated environment.
 *
 ...
 */
class Perception1D51D extends AbstractPerception1D5 implements Perception1D {
	 ...
	 * @param path
	 */
	public Perception1D51D(UUID frustum, IntersectionType type, Entity1D5<?> perceivedObject,
			double relativeCurvilineDistance,
	 ...
	 */
	@Override
	public double getPerceivedObjectDistance() {
