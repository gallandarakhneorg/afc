 ...
 */
public class XMLSimulationConfigParser3D
extends XMLSimulationConfigParser {

	/**
	 * @param resource is the path to the XML resource.
	 */
	public XMLSimulationConfigParser3D(File resource) {
		super(resource);
	}
	 ...
	 * @param resource is the path to the XML resource.
	 */
	public XMLSimulationConfigParser3D(URL resource) {
		super(resource);
	}
	 ...
	 * @param resource is the path to the XML resource.
	 */
	public XMLSimulationConfigParser3D(InputStream resource) {
		super(resource);
	}
