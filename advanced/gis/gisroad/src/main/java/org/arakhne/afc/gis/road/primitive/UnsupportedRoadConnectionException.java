 ...
 * @since 14.0
 */
public class UnsupportedRoadConnectionException extends RoadNetworkException {
	 ...
	 * @param exception the cause of the error.
	 */
	public UnsupportedRoadConnectionException(String message, Throwable exception) {
