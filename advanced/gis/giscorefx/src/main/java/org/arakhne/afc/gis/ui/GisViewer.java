...
/** View of GIS elements that provides a basic UI to show them.
 *
 * <p>The GIS elements are displayed within a {@link GisCanvas} by the {@link GisDrawer drawers}
 * that are declared as services.
 *
 * <p>The {@code GisViewer} provides advanced UI components (scroll bars, etc.)
 ...
 * @since 15.0
 */
public interface GisViewer<T extends MapElement> {
	 ...
	 * 1 means that the map is zooming in. A value below 1 means that
	...
	/** Name of the property for the bounds of the map in GIS coordinates.
	 */
	String MAP_BOUNDS_PROPERTY = "mapBounds"; //$NON-NLS-1$

	/** Name of the property for the bounds of the viewport in GIS coordinates.
	 */
	String VIEWPORT_BOUNDS_PROPERTY = "viewportBounds"; //$NON-NLS-1$

	/** Name of the property for the x coordinate of the viewport center in GIS coordinates.
	 */
	String VIEWPORT_CENTER_X_PROPERTY = "viewportCenterX"; //$NON-NLS-1$

	/** Name of the property for the y coordinate of the viewport center in GIS coordinates.
	 */
	...
	/** Name of the property for the map model.
	 */
	String MAP_MODEL_PROPERTY = "mapModel"; //$NON-NLS-1$

	/** Name of the property for the map drawer.
	 */
	String MAP_DRAWER_PROPERTY = "mapDrawer"; //$NON-NLS-1$
	...
	/** Replies the property that contains the map model.
	 *
	 * @return the property.
	 */
	@Pure
	ObjectProperty<GISElementContainer<T>> mapModelProperty();

	/** Replies the model of the GIS map.
	 *
	 * @return the model of the GIS map.
	 */
	@Pure
	GISElementContainer<T> getMapModel();

	/** Change the model of the GIS map.
	 *
	 * @param model the model of the GIS map.
	 */
	void setMapModel(GISElementContainer<T> model);

	/** Replies the property that contains the map drawer.
	 *
	 * @return the property.
	 */
	@Pure
	ObjectProperty<GisContainerDrawer<T>> mapDrawerProperty();

	/** Replies the drawer of the GIS map.
	 *
	 * @return the drawer of the GIS map.
	 */
	@Pure
	GisContainerDrawer<T> getMapDrawer();

	/** Change the drawer of the GIS map.
	 *
	 * @param drawer the drawer of the GIS map.
	 */
	void setMapDrawer(GisContainerDrawer<T> drawer);

	/** Replies the property that contains the map bounds.
	 *
	 * @return the property.
	 */
	@Pure
	ReadOnlyObjectProperty<Rectangle2afp<?, ?, ?, ?, ?, ?>> mapBoundsProperty();

	/** Replies the bounds of the GIS map.
	 *
	 * @return the bounds of the GIS map.
	 */
	@Pure
	Rectangle2afp<?, ?, ?, ?, ?, ?> getMapBounds();
	...
	/** Replies the property for the x coordinate of the viewport center in GIS coordinates.
	 *
	 * @return the property.
	 */
	@Pure
	...
	/** Replies the x coordinate of the viewport center in GIS coordinates.
	 *
	...
	/** Change the x coordinate of the viewport center in GIS coordinates.
	 *
	 * @param x the x coordinate of the viewport center in GIS coordinates.
	 */
	void setViewportCenterX(double x);

	/** Replies the property for the y coordinate of the viewport center in GIS coordinates.
	 *
	 * @return the property.
	 */
	@Pure
	...
	/** Replies the y coordinate of the viewport center in GIS coordinates.
	 *
	...
	/** Change the y coordinate of the viewport center in GIS coordinates.
	 *
	 * @param y the y coordinate of the viewport center in GIS coordinates.
	 */
	void setViewportCenterY(double y);

	/** Change the coordinates of the viewport center in GIS coordinates.
	 *
	 * @param x the x coordinate of the viewport center in GIS coordinates.
	 * @param y the y coordinate of the viewport center in GIS coordinates.
	 */
	...
	/** Replies the property that contains the viewport bounds in the map coordinates.
	 *
	 * @return the property.
	 */
	@Pure
	ReadOnlyObjectProperty<Rectangle2d> viewportBoundsProperty();

	/** Replies the bounds of the viewport in Map coordinates.
	 *
	...
	default void setScaleValueToFit(boolean minimizeOnly) {
		...
		setScaleValue(scale, map.getCenterX(), map.getCenterY());
	}
	 ...
	 * standard JavaFX coordinate system.
	 *
	 * @param inverted the x coordinate of the viewport center in GIS coordinates.
	 */
	 ...
	 * standard JavaFX coordinate system.
	 *
	 * @param inverted the Y coordinate of the viewport center in GIS coordinates.
	 */
