...
class BusItineraryStub extends BusItinerary {

	private static final long serialVersionUID = 6848342088947186718L;
	 ...
	 * @param name
	 */
	public BusItineraryStub(BusNetwork bn, String name) {
		super(name);
		this.busNetwork = bn;
	}
	 ...
	 * @param bn
	 */
	public BusItineraryStub(BusNetwork bn) {
		super();
		this.busNetwork = bn;
	}
