 ...
 * @since 14.0
 */
public class MapMultiPointRenderer extends AbstractMapMultiPointRenderer<MapMultiPoint> {

	@Override
	@Pure
	public Node drawShape(MapMultiPoint element, RectangularShape2afp<?, ?, ?, ?, ?, ?> bounds) {
