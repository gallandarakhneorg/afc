...
import org.arakhne.afc.math.geometry.d2.tests.afp.AbstractParallelogram2afpTestCase;
import org.arakhne.afc.math.geometry.fx.d2.d.Parallelogram2dfx;
...
@DisplayName("Parallelogram2dfx")
@SuppressWarnings("all")
public class Parallelogram2dfxTest extends AbstractParallelogram2afpTestCase<Parallelogram2dfx, Rectangle2dfx> {
	...
	public class FirstAxisProperty {
		...
		@DisplayName("Change target object")
		@Nested
		...
		@DisplayName("Change property with unit vector")
		@Nested
		public class ChangePropertyWithUnitVector {
	...
	public class SecondAxisProperty {
		...
		public class ChangeTargetObject {
			...
			@ParameterizedTest(name = "{index} => {0}")
			@EnumSource(CoordinateSystem2D.class)
			public void secondAxisProperty_setObject_assertion1(CoordinateSystem2D cs) {
				setUp(cs);
			...
			@ParameterizedTest(name = "{index} => {0}")
			@EnumSource(CoordinateSystem2D.class)
			public void secondAxisProperty_setObject_assertion2(CoordinateSystem2D cs) {
				setUp(cs);
			...
			@ParameterizedTest(name = "{index} => {0}")
			@EnumSource(CoordinateSystem2D.class)
			public void secondAxisProperty_setObject_assertion3(CoordinateSystem2D cs) {
				setUp(cs);
				assertNotNull(property);
			}
			...
			@ParameterizedTest(name = "{index} => {0}")
			@EnumSource(CoordinateSystem2D.class)
			public void secondAxisProperty_setObject_assertion4(CoordinateSystem2D cs) {
				setUp(cs);
			...
			@ParameterizedTest(name = "{index} => {0}")
			@EnumSource(CoordinateSystem2D.class)
			public void secondAxisProperty_setObject_assertion5(CoordinateSystem2D cs) {
				setUp(cs);
			...
			@ParameterizedTest(name = "{index} => {0}")
			@EnumSource(CoordinateSystem2D.class)
			public void secondAxisProperty_setObject_assertion6(CoordinateSystem2D cs) {
				setUp(cs);
				shape.setSecondAxis(0.500348, 0.865824);
				assertEpsilonEquals(0.500348, property.getX());
			}
			...
			@ParameterizedTest(name = "{index} => {0}")
			@EnumSource(CoordinateSystem2D.class)
			public void secondAxisProperty_setObject_assertion7(CoordinateSystem2D cs) {
				setUp(cs);
				shape.setSecondAxis(0.500348, 0.865824);
				assertEpsilonEquals(0.865824, property.getY());
			}
		...
		public class ChangeProperty {
			...
			@ParameterizedTest(name = "{index} => {0}")
			@EnumSource(CoordinateSystem2D.class)
			public void secondAxisProperty_setProperty_assertion1(CoordinateSystem2D cs) {
				setUp(cs);
				assertEpsilonEquals(vx, shape.getSecondAxisX());
			}
			...
			@ParameterizedTest(name = "{index} => {0}")
			@EnumSource(CoordinateSystem2D.class)
			public void secondAxisProperty_setProperty_assertion2(CoordinateSystem2D cs) {
				setUp(cs);
				assertEpsilonEquals(vy, shape.getSecondAxisY());
			}
			...
			@ParameterizedTest(name = "{index} => {0}")
			@EnumSource(CoordinateSystem2D.class)
			public void secondAxisProperty_setProperty_assertion3(CoordinateSystem2D cs) {
				setUp(cs);
				assertNotNull(property);
			}
			...
			@ParameterizedTest(name = "{index} => {0}")
			@EnumSource(CoordinateSystem2D.class)
			public void secondAxisProperty_setProperty_assertion4(CoordinateSystem2D cs) {
				setUp(cs);
				assertEpsilonEquals(vx, property.getX());
			}
			...
			@ParameterizedTest(name = "{index} => {0}")
			@EnumSource(CoordinateSystem2D.class)
			public void secondAxisProperty_setProperty_assertion5(CoordinateSystem2D cs) {
				setUp(cs);
				assertEpsilonEquals(vy, property.getY());
			}
			...
			@ParameterizedTest(name = "{index} => {0}")
			@EnumSource(CoordinateSystem2D.class)
			public void secondAxisProperty_setProperty_assertion6(CoordinateSystem2D cs) {
				setUp(cs);
				property.set(0.500348, 0.865824);
				assertEpsilonEquals(0.500348, property.getX());
			}
			...
			@ParameterizedTest(name = "{index} => {0}")
			@EnumSource(CoordinateSystem2D.class)
			public void secondAxisProperty_setProperty_assertion7(CoordinateSystem2D cs) {
				setUp(cs);
				property.set(0.500348, 0.865824);
				assertEpsilonEquals(0.865824, property.getY());
			}
		...
		public class ChangePropertyWithUnitVector {
			...
			@ParameterizedTest(name = "{index} => {0}")
			@EnumSource(CoordinateSystem2D.class)
			public void secondAxisProperty_setProperty_notUnitVector_assertion1(CoordinateSystem2D cs) {
				CoordinateSystem2D.setDefaultCoordinateSystem(cs);
				assertThrows(AssertionError.class, () -> {
					UnitVectorProperty property = shape.secondAxisProperty();
					property.set(456.159, 789.357);
				});
			}
		}
