...
import org.arakhne.afc.math.geometry.d2.tests.afp.AbstractTriangle2afpTestCase;
import org.arakhne.afc.math.geometry.fx.d2.d.Rectangle2dfx;
import org.arakhne.afc.math.geometry.fx.d2.d.Triangle2dfx;
import org.junit.jupiter.api.DisplayName;
import org.junit.jupiter.api.Nested;
import org.junit.jupiter.params.ParameterizedTest;
import org.junit.jupiter.params.provider.EnumSource;

@DisplayName("Triangle2dfx")
@SuppressWarnings("all")
public class Triangle2dfxTest extends AbstractTriangle2afpTestCase<Triangle2dfx, Rectangle2dfx> {
	...
	public class X1Property {
		...
		public void x1Property_assertion1(CoordinateSystem2D cs) {
			setUp(cs);
			assertEpsilonEquals(5, shape.getX1());
		}
	...
	public class Y1Property {
		...
		public void y1Property_assertion1(CoordinateSystem2D cs) {
			setUp(cs);
			assertEpsilonEquals(8, shape.getY1());
		}
	...
	public class X2Property {
		...
		public void x2Property_assertion1(CoordinateSystem2D cs) {
			setUp(cs);
			assertEpsilonEquals(-10, shape.getX2());
		}
	...
	@DisplayName("x3Property")
	@Nested
	public class X3Property {

		private DoubleProperty property;

		public void setUp(CoordinateSystem2D cs) {
			CoordinateSystem2D.setDefaultCoordinateSystem(cs);
			property = shape.x3Property();
		}

		@DisplayName("#1")
		@ParameterizedTest(name = "{index} => {0}")
		@EnumSource(CoordinateSystem2D.class)
		public void x3Property_assertion1(CoordinateSystem2D cs) {
			setUp(cs);
		...
		@ParameterizedTest(name = "{index} => {0}")
		@EnumSource(CoordinateSystem2D.class)
		public void x3Property_assertion2(CoordinateSystem2D cs) {
			setUp(cs);
			assertNotNull(property);
		}
		...
		@ParameterizedTest(name = "{index} => {0}")
		@EnumSource(CoordinateSystem2D.class)
		public void x3Property_assertion3(CoordinateSystem2D cs) {
			setUp(cs);
			assertEpsilonEquals(-1, property.get());
		}
		...
		@ParameterizedTest(name = "{index} => {0}")
		@EnumSource(CoordinateSystem2D.class)
		public void x3Property_assertion4(CoordinateSystem2D cs) {
			setUp(cs);
			shape.setX3(456.159);
			assertEpsilonEquals(456.159, property.get());
		}
		...
		@ParameterizedTest(name = "{index} => {0}")
		@EnumSource(CoordinateSystem2D.class)
		public void x3Property_assertion5(CoordinateSystem2D cs) {
			setUp(cs);
			shape.setX3(456.159);
			assertEpsilonEquals(456.159, shape.getX3());
		}
	}

	@DisplayName("y3Property")
	@Nested
	public class Y3Property {

		private DoubleProperty property;

		public void setUp(CoordinateSystem2D cs) {
			CoordinateSystem2D.setDefaultCoordinateSystem(cs);
			property = shape.y3Property();
		}

		@DisplayName("#1")
		@ParameterizedTest(name = "{index} => {0}")
		@EnumSource(CoordinateSystem2D.class)
		public void y3Property_assertion1(CoordinateSystem2D cs) {
			setUp(cs);
		...
		@ParameterizedTest(name = "{index} => {0}")
		@EnumSource(CoordinateSystem2D.class)
		public void y3Property_assertion2(CoordinateSystem2D cs) {
			setUp(cs);
			assertNotNull(property);
		}
		...
		@ParameterizedTest(name = "{index} => {0}")
		@EnumSource(CoordinateSystem2D.class)
		public void y3Property_assertion3(CoordinateSystem2D cs) {
			setUp(cs);
		...
		@ParameterizedTest(name = "{index} => {0}")
		@EnumSource(CoordinateSystem2D.class)
		public void y3Property_assertion4(CoordinateSystem2D cs) {
			setUp(cs);
			shape.setY3(456.159);
			assertEpsilonEquals(456.159, property.get());
		}
		...
		@ParameterizedTest(name = "{index} => {0}")
		@EnumSource(CoordinateSystem2D.class)
		public void y3Property_assertion5(CoordinateSystem2D cs) {
			setUp(cs);
			shape.setY3(456.159);
			assertEpsilonEquals(456.159, shape.getY3());
		}
	}
