 ...
 * @since 13.0
 */
public class Segment2ifxOld extends AbstractShape2ifx<Segment2ifx>
	 ...
	 */
	public Segment2ifxOld(Point2D<?, ?> p1, Point2D<?, ?> p2) {
	 ...
	 */
	public Segment2ifxOld(Segment2ai<?, ?, ?, ?, ?, ?> segment) {
	 ...
	 */
	public Segment2ifxOld(int x1, int y1, int x2, int y2) {
		set(x1, y1, x2, y2);
	}
