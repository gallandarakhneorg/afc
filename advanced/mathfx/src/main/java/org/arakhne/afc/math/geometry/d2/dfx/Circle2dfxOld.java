 ...
 * @since 13.0
 */
public class Circle2dfxOld
		extends AbstractShape2dfx<Circle2dfxOld>
		implements Circle2afp<Shape2dfx<?>, Circle2dfxOld, PathElement2dfx, Point2dfx, Vector2dfx, Rectangle2dfx> {
	 ...
	 */
	public Circle2dfxOld(Point2D<?, ?> center, double radius) {
	 ...
	 * @param radius the radius of the circle.
	 */
	public Circle2dfxOld(double x, double y, double radius) {
		set(x, y, radius);
	}
	 ...
	 */
	public Circle2dfxOld(Circle2afp<?, ?, ?, ?, ?, ?> circle) {
	...
	@Pure
	@Override
	public Circle2dfxOld clone() {
		final Circle2dfxOld clone = super.clone();
