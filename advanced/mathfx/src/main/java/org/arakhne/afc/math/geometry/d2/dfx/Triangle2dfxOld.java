...
public class Triangle2dfxOld
	 ...
	 */
	public Triangle2dfxOld(Point2D<?, ?> p1, Point2D<?, ?> p2, Point2D<?, ?> p3) {
	 ...
	 */
	public Triangle2dfxOld(double x1, double y1, double x2, double y2, double x3, double y3) {
	 ...
	 */
	public Triangle2dfxOld(Triangle2afp<?, ?, ?, ?, ?, ?> triangle) {
