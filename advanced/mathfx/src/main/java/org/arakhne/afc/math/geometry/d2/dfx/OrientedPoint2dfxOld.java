 ...
 */
public class OrientedPoint2dfxOld
    extends Point2dfx
     ...
     */
    public OrientedPoint2dfxOld(Tuple2D<?> tuple) {
        super(tuple);
    }
     ...
     */
    public OrientedPoint2dfxOld(double x, double y) {
       super(x, y);
    }
     ...
     * @param y y coordinate of the point.
     */
    public OrientedPoint2dfxOld(DoubleProperty x, DoubleProperty y) {
        super(x, y);
    }
     ...
     */
    public OrientedPoint2dfxOld(Point2D<?, ?> point, Vector2D<?, ?> vector) {
     ...
     */
    public OrientedPoint2dfxOld(double x, double y, double tanX, double tanY) {
        super(x, y);
    ...
    @Override
    public OrientedPoint2dfxOld clone() {
        final OrientedPoint2dfxOld clone = (OrientedPoint2dfxOld) super.clone();
        if (clone.dx != null) {
            clone.dx = null;
