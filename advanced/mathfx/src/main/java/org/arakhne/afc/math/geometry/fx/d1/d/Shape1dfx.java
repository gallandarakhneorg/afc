...
package org.arakhne.afc.math.geometry.fx.d1.d;
 ...
 * @since 14.0
 */
public interface Shape1dfx<IT extends Shape1dfx<?>>
		extends Shape1afp<Shape1dfx<?>, IT, Point1dfx, Vector1dfx, Segment1D<?, ?>, Rectangle1dfx> {

	/** Replies the property that contains the bounding box for this shape.
	 *
	 * @return the bounding box.
	 */
	ObjectProperty<Rectangle1dfx> boundingBoxProperty();
