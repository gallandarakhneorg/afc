...
public class Path2dfxOld extends AbstractShape2dfx<Path2dfxOld>
		implements Path2afp<Shape2dfx<?>, Path2dfxOld, PathElement2dfx, Point2dfx, Vector2dfx, Rectangle2dfx> {
	 ...
	 */
	public Path2dfxOld(Iterator<PathElement2dfx> iterator) {
	 ...
	 */
	public Path2dfxOld(PathWindingRule windingRule) {
	 ...
	 * @param iterator the iterator that provides the elements to copy.
	 */
	public Path2dfxOld(PathWindingRule windingRule, Iterator<PathElement2dfx> iterator) {
	 ...
	 */
	public Path2dfxOld(Path2afp<?, ?, ?, ?, ?, ?> path) {
		set(path);
	}
	...
	@Pure
	@Override
	public Path2dfxOld clone() {
		final Path2dfxOld clone = super.clone();
		clone.coords = null;
		if (this.coords != null && !this.coords.isEmpty()) {
	...
	@Override
	public void set(Path2dfxOld path) {
