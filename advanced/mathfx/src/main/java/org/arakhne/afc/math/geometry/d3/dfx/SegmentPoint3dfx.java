 ...
 * @since 13.0
 */
public class SegmentPoint3dfx extends AbstractShape3dfx<SegmentPoint3dfx>
	implements Segment3afp<Shape3dfx<?>, SegmentPoint3dfx, PathElement3dfx, Point3dfx, Vector3dfx, RectangularPrism3dfx> {
	 ...
	 */
	public SegmentPoint3dfx(Point3D<?, ?> p1, Point3D<?, ?> p2) {
     ...
     * @param p2 second point.
     */
	public SegmentPoint3dfx(Point3dfx p1, Point3dfx p2) {
	    this.p1 = p1;
	    this.p2 = p2;
	}
	 ...
	 */
	public SegmentPoint3dfx(Segment3afp<?, ?, ?, ?, ?, ?> segment) {
     ...
     * @param segment the segment to copy.
     */
	public SegmentPoint3dfx(SegmentPoint3dfx segment) {
	    this.p1 = segment.p1;
	    this.p2 = segment.p2;
	}
     ...
     */
	public SegmentPoint3dfx(double x1, double y1, double z1, double x2, double y2, double z2) {
		set(x1, y1, z1, x2, y2, z2);
	}

	@Override
	public SegmentPoint3dfx clone() {
		final SegmentPoint3dfx clone = super.clone();
		if (clone.p1 != null) {
	...
	@Pure
	@Override
	public SegmentPoint3dfx createTransformedShape(Transform3D transform) {
		...
		transform.transform(point);
		return new SegmentPoint3dfx(x1, y1, z1, point.getX(), point.getY(), point.getZ());
	}
