 ...
 * @since 13.0
 */
public class SegmentPoint2ifx extends AbstractShape2ifx<SegmentPoint2ifx>
	implements Segment2ai<Shape2ifx<?>, SegmentPoint2ifx, PathElement2ifx, Point2ifx, Vector2ifx, Rectangle2ifx> {
	 ...
	 */
	public SegmentPoint2ifx(Point2ifx p1, Point2ifx p2) {
	    this.p1 = p1;
	    this.p2 = p2;
	}
     ...
     * @param p2 second point.
     */
	public SegmentPoint2ifx(Point2D<?, ?> p1, Point2D<?, ?> p2) {
	 ...
	 */
	public SegmentPoint2ifx(SegmentPoint2ifx segment) {
	    this.p1 = segment.p1;
	    this.p2 = segment.p2;
	}
     ...
     * @param segment the segment to copy.
     */
	public SegmentPoint2ifx(Segment2ai<?, ?, ?, ?, ?, ?> segment) {
     ...
     */
	public SegmentPoint2ifx(int x1, int y1, int x2, int y2) {
		set(x1, y1, x2, y2);
	}

	@Override
	public SegmentPoint2ifx clone() {
		final SegmentPoint2ifx clone = super.clone();
		if (clone.p1 != null) {
	...
	@Pure
	@Override
	public SegmentPoint2ifx createTransformedShape(Transform2D transform) {
		...
		transform.transform(point);
		return new SegmentPoint2ifx(x1, y1, point.ix(), point.iy());
	}
