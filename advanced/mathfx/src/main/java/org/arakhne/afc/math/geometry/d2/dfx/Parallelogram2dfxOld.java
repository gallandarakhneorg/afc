 ...
 * @since 13.0
 */
public class Parallelogram2dfxOld extends AbstractShape2dfx<Parallelogram2dfxOld>
		implements Parallelogram2afp<Shape2dfx<?>, Parallelogram2dfxOld, PathElement2dfx, Point2dfx, Vector2dfx, Rectangle2dfx> {
	 ...
	 */
	public Parallelogram2dfxOld(Parallelogram2afp<?, ?, ?, ?, ?, ?> parallelogram) {
	 ...
	 */
	public Parallelogram2dfxOld(Iterable<? extends Point2D<?, ?>> pointCloud) {
	 ...
	 * @param pointCloud - the cloud of points.
	 */
	public Parallelogram2dfxOld(Point2D<?, ?>... pointCloud) {
		setFromPointCloud(pointCloud);
	}
	...
	public Parallelogram2dfxOld(double centerX, double centerY,
	 ...
	 */
	public Parallelogram2dfxOld(Point2D<?, ?> center, Vector2D<?, ?> axis1, double axis1Extent,
			Vector2D<?, ?> axis2, double axis2Extent) {
		set(center, axis1, axis1Extent, axis2, axis2Extent);
	}

	@Override
	public Parallelogram2dfxOld clone() {
		final Parallelogram2dfxOld clone = super.clone();
		if (clone.cx != null) {
			clone.cx = null;
