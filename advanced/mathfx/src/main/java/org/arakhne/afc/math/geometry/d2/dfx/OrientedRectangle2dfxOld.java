 ...
 * @since 13.0
 */
public class OrientedRectangle2dfxOld extends AbstractShape2dfx<OrientedRectangle2dfxOld>
		implements OrientedRectangle2afp<Shape2dfx<?>, OrientedRectangle2dfxOld, PathElement2dfx,
	 ...
	 */
	public OrientedRectangle2dfxOld() {
		//
	}
	 ...
	 */
	public OrientedRectangle2dfxOld(OrientedRectangle2afp<?, ?, ?, ?, ?, ?> obr) {
	 ...
	 */
	public OrientedRectangle2dfxOld(Iterable<? extends Point2D<?, ?>> pointCloud) {
	 ...
	 * @param pointCloud - the cloud of points.
	 */
	public OrientedRectangle2dfxOld(Point2D<?, ?>... pointCloud) {
		assert pointCloud != null : AssertMessages.notNullParameter();
	 ...
	 */
	public OrientedRectangle2dfxOld(double centerX, double centerY,
	 ...
	 * @param axis2Extent is the extent of the second axis.
	 */
	public OrientedRectangle2dfxOld(Point2D<?, ?> center, Vector2D<?, ?> axis1, double axis1Extent, double axis2Extent) {
		set(center, axis1, axis1Extent, axis2Extent);
	}

	@Override
	public OrientedRectangle2dfxOld clone() {
		final OrientedRectangle2dfxOld clone = super.clone();
		if (clone.cx != null) {
			clone.cx = null;
