...
* Alexandre WILLAUME, junior developer, vmutil module.
* Christophe BOHRHAUER, student developer, math module.
* Hamza JAFFALI, student developer, math module.
* Christophe BOHRHAUER, student developer, math module.
* Marc BAUMGARTNER, contributor.
* Maxime GROLLEAU, student developer, math module.
* Mahdi HANNOUN, Founder, original Author.
* Nicolas GAUD, senior developer, math module.
* Olivier LAMOTTE, senior developer, vmutil and math modules.
* link:http://www.arakhne.org/homes/galland.html[Stéphane GALLAND], founder, original author.
* Thomas PIOTROWSKI, student developer, math module.
* Yuku SUGIANTO, contributor.
