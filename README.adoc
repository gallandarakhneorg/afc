...
|
| link:http://arakhne.org/afc/apidocs/index.html?org/arakhne/afc/gis/io/package-summary.html[GIS Bus Network]
| org.arakhne.afc.gis
| gisbusinputoutput
| Readers and writers for bus networks.
...
|
| link:http://arakhne.org/afc/apidocs/index.html?org/arakhne/afc/gis/road/package-summary.html[GIS Road Network]
| org.arakhne.afc.gis
| gisroad
...
| gisroadfx
| JavaFX panel and canvas dedicated to road networks.

|
| link:http://arakhne.org/afc/apidocs/index.html?org/arakhne/afc/gis/road/io/package-summary.html[GIS Road Network]
| org.arakhne.afc.gis
| gisroadinputoutput
| Readers and writers for road networks.
...
Please, replace Version `17.0` in the previous snipset by the number of the version you want to use (`17.0` is the first version that is available on Maven Central).
