 ...
 */
public class GeometryUtilTest extends AbstractRepeatedTestCase {

	private float oldRadianEpsilon;
	private float oldTrigoEpsilon;
	private float oldDistanceEpsilon;
	
	@Override
	public void setUp() throws Exception {
		super.setUp();
		this.oldRadianEpsilon = MathUtil.getRadianEpsilon();
		this.oldTrigoEpsilon = MathUtil.getTrigonometricEpsilon();
		this.oldDistanceEpsilon = MathUtil.getDistanceEpsilon();
	}
	
	@Override
	public void tearDown() throws Exception {
		super.setUp();
		MathUtil.setRadianEpsilon(this.oldRadianEpsilon);
		MathUtil.setTrigonometricEpsilon(this.oldTrigoEpsilon);
		MathUtil.setDistanceEpsilon(this.oldDistanceEpsilon);
	}

	/**
	 */
	public void testSetRadianEpsilon() {
		float newValue = this.RANDOM.nextFloat();
		assertEquals(this.oldRadianEpsilon, MathUtil.setRadianEpsilon(newValue));
		assertEquals(newValue, MathUtil.getRadianEpsilon());
	}

	/**
	 */
	public void testSetTrigonometricEpsilon() {
		float newValue = this.RANDOM.nextFloat();
		assertEquals(this.oldTrigoEpsilon, MathUtil.setTrigonometricEpsilon(newValue));
		assertEquals(newValue, MathUtil.getTrigonometricEpsilon());
	}

	/**
	 */
	public void testSetDistanceEpsilon() {
		float newValue = this.RANDOM.nextFloat();
		assertEquals(this.oldDistanceEpsilon, MathUtil.setDistanceEpsilon(newValue));
		assertEquals(newValue, MathUtil.getDistanceEpsilon());
	}
	...
	public void testDistanceFloatFloatFloatFloatFloatFloat() {
		...
		assertZero(MathUtil.distance(p1.getX(),p1.getY(),p1.getZ(), p1.getX(),p1.getY(),p1.getZ()));
		assertZero(MathUtil.distance(p2.getX(),p2.getY(),p2.getZ(), p2.getX(),p2.getY(),p2.getZ()));
		...
		assertEquals(expectedDistance, MathUtil.distance(p1.getX(),p1.getY(),p1.getZ(), p2.getX(),p2.getY(),p2.getZ()));
		assertEquals(expectedDistance, MathUtil.distance(p2.getX(),p2.getY(),p2.getZ(), p1.getX(),p1.getY(),p1.getZ()));
	}
	...
	public void testDistanceSquaredFloatFloatFloatFloatFloatFloat() {
		...
		assertZero(MathUtil.distanceSquared(p1.getX(),p1.getY(),p1.getZ(), p1.getX(),p1.getY(),p1.getZ()));
		assertZero(MathUtil.distanceSquared(p2.getX(),p2.getY(),p2.getZ(), p2.getX(),p2.getY(),p2.getZ()));
		...
		assertEquals(expectedDistance, MathUtil.distanceSquared(p1.getX(),p1.getY(),p1.getZ(), p2.getX(),p2.getY(),p2.getZ()));
		assertEquals(expectedDistance, MathUtil.distanceSquared(p2.getX(),p2.getY(),p2.getZ(), p1.getX(),p1.getY(),p1.getZ()));
	}
	...
	public void testDistancePointSegmentFloatFloatFloatFloatFloatFloat() {
		...
		float r = MathUtil.projectsPointOnSegment(p1.getX(), p1.getY(), p2.getX(), p2.getY(), p3.getX(), p3.getY());
	...
	public void testProjectsPointOnSegmentFloatFloatFloatFloatFloatFloat() {
		...
		float actual = MathUtil.projectsPointOnSegment(p1.getX(), p1.getY(), p2.getX(), p2.getY(), p3.getX(), p3.getY());
		...
		p3 = new Point2f(p1);
		assertZero(MathUtil.projectsPointOnSegment(p3.getX(), p3.getY(), p1.getX(), p1.getY(), p2.getX(), p2.getY()));
		assertEquals(1.f, MathUtil.projectsPointOnSegment(p3.getX(), p3.getY(), p2.getX(), p2.getY(), p1.getX(), p1.getY()));

		p3 = new Point2f(p2);
		assertEquals(1.f, MathUtil.projectsPointOnSegment(p3.getX(), p3.getY(), p1.getX(), p1.getY(), p2.getX(), p2.getY()));
		assertEquals(-0.f, MathUtil.projectsPointOnSegment(p3.getX(), p3.getY(), p2.getX(), p2.getY(), p1.getX(), p1.getY()));

		p3 = new Point2f(0.f, 0.f);
		assertEquals(.5f, MathUtil.projectsPointOnSegment(p3.getX(), p3.getY(), p1.getX(), p1.getY(), p2.getX(), p2.getY()));
		assertEquals(.5f, MathUtil.projectsPointOnSegment(p3.getX(), p3.getY(), p2.getX(), p2.getY(), p1.getX(), p1.getY()));
		...
		assertEquals(-1.f, MathUtil.projectsPointOnSegment(p3.getX(), p3.getY(), p1.getX(), p1.getY(), p2.getX(), p2.getY()));
		assertEquals(2.f, MathUtil.projectsPointOnSegment(p3.getX(), p3.getY(), p2.getX(), p2.getY(), p1.getX(), p1.getY()));

		p3 = new Point2f(300, 300.f);
		assertEquals(2.f, MathUtil.projectsPointOnSegment(p3.getX(), p3.getY(), p1.getX(), p1.getY(), p2.getX(), p2.getY()));
		assertEquals(-1.f, MathUtil.projectsPointOnSegment(p3.getX(), p3.getY(), p2.getX(), p2.getY(), p1.getX(), p1.getY()));
	}
	...
	public void testSignedAngleFloatFloatFloatFloat() {
		...
		assertEpsilonEquals(0.f, MathUtil.signedAngle(v1.getX(), v1.getY(), v1.getX(), v1.getY()));
		assertEpsilonEquals(0.f, MathUtil.signedAngle(v2.getX(), v2.getY(), v2.getX(), v2.getY()));
		
		float sAngle1 = MathUtil.signedAngle(v1.getX(), v1.getY(), v2.getX(), v2.getY());
		float sAngle2 = MathUtil.signedAngle(v2.getX(), v2.getY(), v1.getX(), v1.getY());
	...
	public void testSignedAngleFloatFloatFloatFloatFloatFloat() {
		{
			...
			float sAngle1 = MathUtil.signedAngle(v1.getX(), v1.getY(), v1.getZ(), v2.getX(), v2.getY(), v2.getZ());
			float sAngle2 = MathUtil.signedAngle(v2.getX(), v2.getY(), v2.getZ(), v1.getX(), v1.getY(), v1.getZ());
...

		{
			...
			assertEpsilonEquals(0.f, MathUtil.signedAngle(v1.getX(), v1.getY(), v1.getZ(), v1.getX(), v1.getY(), v1.getZ()));
			assertEpsilonEquals(0.f, MathUtil.signedAngle(v2.getX(), v2.getY(), v2.getZ(), v2.getX(), v2.getY(), v2.getZ()));
	...
	public void testIsParallelLinesPoint2dPoint2dPoint2dPoint2d() {
		...
		p3 = new Point2f(p1);
		p4 = new Point2f(p2);
		assertTrue(MathUtil.isParallelLines(p1, p2, p3, p4));
		assertTrue(MathUtil.isParallelLines(p1, p2, p4, p3));
		...
		p4 = new Point2f(p2);
		assertFalse(MathUtil.isParallelLines(p1, p2, p3, p4));
		assertFalse(MathUtil.isParallelLines(p1, p2, p4, p3));
	...
	public void testIsParallelLinesFloatFloatFloatFloatFloatFloatFloatFloat() {
		...
		p3 = new Point2f(p1);
		p4 = new Point2f(p2);
		assertTrue(MathUtil.isParallelLines(p1.getX(),p1.getY(), p2.getX(),p2.getY(), p3.getX(),p3.getY(), p4.getX(),p4.getY()));
		assertTrue(MathUtil.isParallelLines(p1.getX(),p1.getY(), p2.getX(),p2.getY(), p4.getX(),p4.getY(), p3.getX(),p3.getY()));
		...
		p3 = new Point2f(p1.getX()+100.f, p1.getY());
		p4 = new Point2f(p2);
		assertFalse(MathUtil.isParallelLines(p1.getX(),p1.getY(), p2.getX(),p2.getY(), p3.getX(),p3.getY(), p4.getX(),p4.getY()));
		assertFalse(MathUtil.isParallelLines(p1.getX(),p1.getY(), p2.getX(),p2.getY(), p4.getX(),p4.getY(), p3.getX(),p3.getY()));
	...
	public void testIsParallelLinesFloatFloatFloatFloatFloatFloatFloatFloatFloatFloatFloatFloat() {
		...
		p3 = new Point3f(p1);
		p4 = new Point3f(p2);
		assertTrue(MathUtil.isParallelLines(p1.getX(),p1.getY(),p1.getZ(), p2.getX(),p2.getY(),p2.getZ(), p3.getX(),p3.getY(),p3.getZ(), p4.getX(),p4.getY(),p4.getZ()));
		assertTrue(MathUtil.isParallelLines(p1.getX(),p1.getY(),p1.getZ(), p2.getX(),p2.getY(),p2.getZ(), p4.getX(),p4.getY(),p4.getZ(), p3.getX(),p3.getY(),p3.getZ()));
		...
		p4 = new Point3f(p2);
		assertFalse(MathUtil.isParallelLines(p1.getX(),p1.getY(),p1.getZ(), p2.getX(),p2.getY(),p2.getZ(), p3.getX(),p3.getY(),p3.getZ(), p4.getX(),p4.getY(),p4.getZ()));
		assertFalse(MathUtil.isParallelLines(p1.getX(),p1.getY(),p1.getZ(), p2.getX(),p2.getY(),p2.getZ(), p4.getX(),p4.getY(),p4.getZ(), p3.getX(),p3.getY(),p3.getZ()));
	...
	public void testIsCollinearPointsFloatFloatFloatFloatFloatFloat() {
		...
		p3 = new Point2f(p1);
		assertTrue(MathUtil.isCollinearPoints(p1.getX(),p1.getY(), p2.getX(),p2.getY(), p3.getX(), p3.getY()));
		...
		assertFalse(MathUtil.isCollinearPoints(p1.getX(),p1.getY(), p2.getX(),p2.getY(), p3.getX(), p3.getY()));
	...
	public void testIsCollinearPointsPoint2dPoint2dPoint2d() {
		...
		p3 = new Point2f(p1);
		assertTrue(MathUtil.isCollinearPoints(p1, p2, p3));
		...
		p3 = new Point2f(-50.f,50.f);
		assertFalse(MathUtil.isCollinearPoints(p1, p2, p3));
	...
	public void testIsCollinearLinesFloatFloatFloatFloatFloatFloatFloatFloat() {
		...
		p3 = new Point2f(p1);
		p4 = new Point2f(p2);
		assertTrue(MathUtil.isCollinearLines(p1.getX(),p1.getY(), p2.getX(),p2.getY(), p3.getX(),p3.getY(), p4.getX(),p4.getY()));
		assertTrue(MathUtil.isCollinearLines(p1.getX(),p1.getY(), p2.getX(),p2.getY(), p4.getX(),p4.getY(), p3.getX(),p3.getY()));
		...
		p3 = new Point2f(p1.getX()+100.f, p1.getY());
		p4 = new Point2f(p2);
		assertFalse(MathUtil.isCollinearLines(p1.getX(),p1.getY(), p2.getX(),p2.getY(), p3.getX(),p3.getY(), p4.getX(),p4.getY()));
		assertFalse(MathUtil.isCollinearLines(p1.getX(),p1.getY(), p2.getX(),p2.getY(), p4.getX(),p4.getY(), p3.getX(),p3.getY()));
	...
	public void testIsCollinearLinesPoint2dPoint2dPoint2dPoint2d() {
		...
		p3 = new Point2f(p1);
		p4 = new Point2f(p2);
		assertTrue(MathUtil.isCollinearLines(p1, p2, p3, p4));
		assertTrue(MathUtil.isCollinearLines(p1, p2, p4, p3));
		...
		p3 = new Point2f(p1.getX()+100.f, p1.getY());
		p4 = new Point2f(p2);
		assertFalse(MathUtil.isCollinearLines(p1, p2, p3, p4));
		assertFalse(MathUtil.isCollinearLines(p1, p2, p4, p3));
	...
	public void testIsCollinearPointsFloatFloatFloatFloatFloatFloatFloatFloatFloat() {
		...
		assertTrue(MathUtil.isCollinearPoints(2.f,-1.f,4.f, -4.f, -4.f, 2.f, 14.f, 5.f, 8.f));
		assertFalse(MathUtil.isCollinearPoints(2.f,-1.f,4.f, -4.f, -4.f, 2.f, 14.f, 5.f, 7.f));

		p3 = new Point3f(p1);
		assertTrue(MathUtil.isCollinearPoints(p1.getX(),p1.getY(),p1.getZ(), p2.getX(),p2.getY(),p2.getZ(), p3.getX(),p3.getY(),p3.getZ()));
		...
		assertFalse(MathUtil.isCollinearPoints(p1.getX(),p1.getY(),p1.getZ(), p2.getX(),p2.getY(),p2.getZ(), p3.getX(),p3.getY(),p3.getZ()));
	...
	public void testIsCollinearPointsPoint3dPoint3dPoint3d() {
		...
		// Numerical application from:
		// http://www.jtaylor1142001.net/calcjat/Solutions/3Dim/Collinear.htm
		assertTrue(MathUtil.isCollinearPoints(new Point3f(2.f,-1.f,4.f), new Point3f(-4.f, -4.f, 2.f), new Point3f(14.f, 5.f, 8.f)));
		assertFalse(MathUtil.isCollinearPoints(new Point3f(2.f,-1.f,4.f), new Point3f(-4.f, -4.f, 2.f), new Point3f(14.f, 5.f, 7.f)));
	...
	public void testIsCollinearVectorsFloatFloatFloatFloat() {
		assertTrue(MathUtil.isCollinearVectors(1.f, 1.f, 1.f, 1.f));
		assertTrue(MathUtil.isCollinearVectors(1.f, 1.f, 2.f, 2.f));
		assertTrue(MathUtil.isCollinearVectors(1.f, 1.f, -1.f, -1.f));
		assertTrue(MathUtil.isCollinearVectors(1.f, 1.f, -2.f, -2.f));
		assertTrue(MathUtil.isCollinearVectors(1.f, 1.f, 0.f, 0.f));
		...
		assertFalse(MathUtil.isCollinearVectors(1.f, -1.f, 1.f, 1.f));
		assertFalse(MathUtil.isCollinearVectors(1.f, 1.f, 2.f, -234.f));
		assertFalse(MathUtil.isCollinearVectors(234.f, -345.f, -3456.f, 2348.f));
		assertFalse(MathUtil.isCollinearVectors(-53.f, 7853.f, -4562.f, -234.f));
	}

	/**
	 */
	public void testIsCollinearVectorsVector2fVector2f() {
		assertTrue(MathUtil.isCollinearVectors(new Vector2f(1.f, 1.f), new Vector2f(1.f, 1.f)));
		assertTrue(MathUtil.isCollinearVectors(new Vector2f(1.f, 1.f), new Vector2f(2.f, 2.f)));
		assertTrue(MathUtil.isCollinearVectors(new Vector2f(1.f, 1.f), new Vector2f(-1.f, -1.f)));
		assertTrue(MathUtil.isCollinearVectors(new Vector2f(1.f, 1.f), new Vector2f(-2.f, -2.f)));
		assertTrue(MathUtil.isCollinearVectors(new Vector2f(1.f, 1.f), new Vector2f(0.f, 0.f)));
		...
		assertFalse(MathUtil.isCollinearVectors(new Vector2f(1.f, -1.f), new Vector2f(1.f, 1.f)));
		assertFalse(MathUtil.isCollinearVectors(new Vector2f(1.f, 1.f), new Vector2f(2.f, -234.f)));
		assertFalse(MathUtil.isCollinearVectors(new Vector2f(234.f, -345.f), new Vector2f(-3456.f, 2348.f)));
		assertFalse(MathUtil.isCollinearVectors(new Vector2f(-53.f, 7853.f), new Vector2f(-4562.f, -234.f)));
	}

	/**
	 */
	public void testIsCollinearVectorsFloatFloatFloatFloatFloatFloat() {
		assertTrue(MathUtil.isCollinearVectors(1.f, 1.f, 1.f, -1.f, -1.f, -1.f));
		assertFalse(MathUtil.isCollinearVectors(1.f, 1.f, 1.f, -1.f, -1.f, 0.f));
		assertFalse(MathUtil.isCollinearVectors(1.f, 1.f, 1.f, -1.f, -1.f, 1.f));
		assertFalse(MathUtil.isCollinearVectors(1.f, 1.f, 1.f, -1.f, 0.f, -1.f));
		assertFalse(MathUtil.isCollinearVectors(1.f, 1.f, 1.f, -1.f, 0.f, 0.f));
		assertFalse(MathUtil.isCollinearVectors(1.f, 1.f, 1.f, -1.f, 0.f, 1.f));
		assertFalse(MathUtil.isCollinearVectors(1.f, 1.f, 1.f, -1.f, 1.f, -1.f));
		assertFalse(MathUtil.isCollinearVectors(1.f, 1.f, 1.f, -1.f, 1.f, 0.f));
		assertFalse(MathUtil.isCollinearVectors(1.f, 1.f, 1.f, -1.f, 1.f, 1.f));

		assertFalse(MathUtil.isCollinearVectors(1.f, 1.f, 1.f, 0.f, -1.f, -1.f));
		assertFalse(MathUtil.isCollinearVectors(1.f, 1.f, 1.f, 0.f, -1.f, 0.f));
		assertFalse(MathUtil.isCollinearVectors(1.f, 1.f, 1.f, 0.f, -1.f, 1.f));
		assertFalse(MathUtil.isCollinearVectors(1.f, 1.f, 1.f, 0.f, 0.f, -1.f));
		assertTrue(MathUtil.isCollinearVectors(1.f, 1.f, 1.f, 0.f, 0.f, 0.f));
		assertFalse(MathUtil.isCollinearVectors(1.f, 1.f, 1.f, 0.f, 0.f, 1.f));
		assertFalse(MathUtil.isCollinearVectors(1.f, 1.f, 1.f, 0.f, 1.f, -1.f));
		assertFalse(MathUtil.isCollinearVectors(1.f, 1.f, 1.f, 0.f, 1.f, 0.f));
		assertFalse(MathUtil.isCollinearVectors(1.f, 1.f, 1.f, 0.f, 1.f, 1.f));
		...
		assertTrue(MathUtil.isCollinearVectors(1234.f, 3245.f, 456.f, 2468.f, 6490.f, 912.f));
		assertFalse(MathUtil.isCollinearVectors(1234.f, 3245.f, 456.f, 2468.f, 6490.f, 914.f));

		assertFalse(MathUtil.isCollinearVectors(1.f, 1.f, 0.f, 1.f, 1.f, 2.f));
		assertFalse(MathUtil.isCollinearVectors(1.f, 0.f, 1.f, 1.f, 2.f, 1.f));
		assertFalse(MathUtil.isCollinearVectors(0.f, 1.f, 1.f, 2.f, 1.f, 1.f));
	}

	/**
	 */
	public void testIsCollinearVectorsVector3dVector3d() {
		assertTrue(MathUtil.isCollinearVectors(new Vector3f(1.f, 1.f, 1.f), new Vector3f(-1.f, -1.f, -1.f)));
		assertFalse(MathUtil.isCollinearVectors(new Vector3f(1.f, 1.f, 1.f), new Vector3f(-1.f, -1.f, 0.f)));
		assertFalse(MathUtil.isCollinearVectors(new Vector3f(1.f, 1.f, 1.f), new Vector3f(-1.f, -1.f, 1.f)));
		assertFalse(MathUtil.isCollinearVectors(new Vector3f(1.f, 1.f, 1.f), new Vector3f(-1.f, 0.f, -1.f)));
		assertFalse(MathUtil.isCollinearVectors(new Vector3f(1.f, 1.f, 1.f), new Vector3f(-1.f, 0.f, 0.f)));
		assertFalse(MathUtil.isCollinearVectors(new Vector3f(1.f, 1.f, 1.f), new Vector3f(-1.f, 0.f, 1.f)));
		assertFalse(MathUtil.isCollinearVectors(new Vector3f(1.f, 1.f, 1.f), new Vector3f(-1.f, 1.f, -1.f)));
		assertFalse(MathUtil.isCollinearVectors(new Vector3f(1.f, 1.f, 1.f), new Vector3f(-1.f, 1.f, 0.f)));
		assertFalse(MathUtil.isCollinearVectors(new Vector3f(1.f, 1.f, 1.f), new Vector3f(-1.f, 1.f, 1.f)));

		assertFalse(MathUtil.isCollinearVectors(new Vector3f(1.f, 1.f, 1.f), new Vector3f(0.f, -1.f, -1.f)));
		assertFalse(MathUtil.isCollinearVectors(new Vector3f(1.f, 1.f, 1.f), new Vector3f(0.f, -1.f, 0.f)));
		assertFalse(MathUtil.isCollinearVectors(new Vector3f(1.f, 1.f, 1.f), new Vector3f(0.f, -1.f, 1.f)));
		assertFalse(MathUtil.isCollinearVectors(new Vector3f(1.f, 1.f, 1.f), new Vector3f(0.f, 0.f, -1.f)));
		assertTrue(MathUtil.isCollinearVectors(new Vector3f(1.f, 1.f, 1.f), new Vector3f(0.f, 0.f, 0.f)));
		assertFalse(MathUtil.isCollinearVectors(new Vector3f(1.f, 1.f, 1.f), new Vector3f(0.f, 0.f, 1.f)));
		assertFalse(MathUtil.isCollinearVectors(new Vector3f(1.f, 1.f, 1.f), new Vector3f(0.f, 1.f, -1.f)));
		assertFalse(MathUtil.isCollinearVectors(new Vector3f(1.f, 1.f, 1.f), new Vector3f(0.f, 1.f, 0.f)));
		assertFalse(MathUtil.isCollinearVectors(new Vector3f(1.f, 1.f, 1.f), new Vector3f(0.f, 1.f, 1.f)));
		...
		assertTrue(MathUtil.isCollinearVectors(new Vector3f(1234.f, 3245.f, 456.f), new Vector3f(2468.f, 6490.f, 912.f)));
		assertFalse(MathUtil.isCollinearVectors(new Vector3f(1234.f, 3245.f, 456.f), new Vector3f(2468.f, 6490.f, 914.f)));
	}
	...
	public void testIsCollinearLinesFloatFloatFloatFloatFloatFloatFloatFloatFloatFloatFloatFloat() {
		...
		p3 = new Point3f(p1);
		p4 = new Point3f(p2);
		assertTrue(MathUtil.isCollinearLines(p1.getX(),p1.getY(),p1.getZ(), p2.getX(),p2.getY(),p2.getZ(), p3.getX(),p3.getY(),p3.getZ(), p4.getX(),p4.getY(),p4.getZ()));
		assertTrue(MathUtil.isCollinearLines(p1.getX(),p1.getY(),p1.getZ(), p2.getX(),p2.getY(),p2.getZ(), p4.getX(),p4.getY(),p4.getZ(), p3.getX(),p3.getY(),p3.getZ()));
		...
		p3 = new Point3f(p1.getX()+100.f, p1.getY(), p1.getZ());
		p4 = new Point3f(p2);
		assertFalse(MathUtil.isCollinearLines(p1.getX(),p1.getY(),p1.getZ(), p2.getX(),p2.getY(),p2.getZ(), p3.getX(),p3.getY(),p3.getZ(), p4.getX(),p4.getY(),p4.getZ()));
		assertFalse(MathUtil.isCollinearLines(p1.getX(),p1.getY(),p1.getZ(), p2.getX(),p2.getY(),p2.getZ(), p4.getX(),p4.getY(),p4.getZ(), p3.getX(),p3.getY(),p3.getZ()));
	...
	public void testProjectsPointOnSegmentFloatFloatFloatFloatFloatFloatFloatFloatFloat() {
		...
		p3 = new Point3f(p1);
		assertZero(MathUtil.projectsPointOnSegment(p3.getX(),p3.getY(),p3.getZ(), p1.getX(),p1.getY(),p1.getZ(), p2.getX(),p2.getY(),p2.getZ()));
		assertEquals(1.f, MathUtil.projectsPointOnSegment(p3.getX(),p3.getY(),p3.getZ(), p2.getX(),p2.getY(),p2.getZ(), p1.getX(),p1.getY(),p1.getZ()));

		p3 = new Point3f(p2);
		assertEquals(1.f, MathUtil.projectsPointOnSegment(p3.getX(),p3.getY(),p3.getZ(), p1.getX(),p1.getY(),p1.getZ(), p2.getX(),p2.getY(),p2.getZ()));
		assertZero(MathUtil.projectsPointOnSegment(p3.getX(),p3.getY(),p3.getZ(), p2.getX(),p2.getY(),p2.getZ(), p1.getX(),p1.getY(),p1.getZ()));

		p3 = new Point3f(0.f, 0.f,50.f);
		assertEquals(.5f, MathUtil.projectsPointOnSegment(p3.getX(),p3.getY(),p3.getZ(), p1.getX(),p1.getY(),p1.getZ(), p2.getX(),p2.getY(),p2.getZ()));
		assertEquals(.5f, MathUtil.projectsPointOnSegment(p3.getX(),p3.getY(),p3.getZ(), p2.getX(),p2.getY(),p2.getZ(), p1.getX(),p1.getY(),p1.getZ()));
		...
		assertEquals(-1.f, MathUtil.projectsPointOnSegment(p3.getX(),p3.getY(),p3.getZ(), p1.getX(),p1.getY(),p1.getZ(), p2.getX(),p2.getY(),p2.getZ()));
		assertEquals(2.f, MathUtil.projectsPointOnSegment(p3.getX(),p3.getY(),p3.getZ(), p2.getX(),p2.getY(),p2.getZ(), p1.getX(),p1.getY(),p1.getZ()));

		p3 = new Point3f(300, 300.f,50.f);
		assertEquals(2.f, MathUtil.projectsPointOnSegment(p3.getX(),p3.getY(),p3.getZ(), p1.getX(),p1.getY(),p1.getZ(), p2.getX(),p2.getY(),p2.getZ()));
		assertEquals(-1.f, MathUtil.projectsPointOnSegment(p3.getX(),p3.getY(),p3.getZ(), p2.getX(),p2.getY(),p2.getZ(), p1.getX(),p1.getY(),p1.getZ()));
	...
	public void testGetLineLineIntersectionFactorFloatFloatFloatFloatFloatFloatFloatFloat() {
		assertNaN(MathUtil.getLineLineIntersectionFactor(
				1.f, 1.f, 2.f, 2.f,
				1.f, 1.f, 2.f, 2.f));
		...
		assertEpsilonEquals(.5f,
				MathUtil.getLineLineIntersectionFactor(
						-1.f, -1.f, 1.f, 1.f,
						-1.f, 1.f, 1.f, -1.f));
	...
	public void testGetSegmentSegmentIntersectionFactorFloatFloatFloatFloatFloatFloatFloatFloat() {
		assertNaN(MathUtil.getSegmentSegmentIntersectionFactor(
				1.f, 1.f, 2.f, 2.f,
				1.f, 1.f, 2.f, 2.f));
		...
		assertEpsilonEquals(0.f,
				MathUtil.getSegmentSegmentIntersectionFactor(
				1.f, 1.f, 2.f, 2.f,
				1.f, 1.f, 3.f, 9.f));
	...
	public void testGetSegmentSegmentIntersectionPointFloatFloatFloatFloatFloatFloatFloatFloat() {
		assertNull(MathUtil.getSegmentSegmentIntersectionPoint(
				1.f, 1.f, 2.f, 2.f,
				1.f, 1.f, 2.f, 2.f));
		...
		assertEpsilonEquals(new Point2f(1.f, 1.f),
				MathUtil.getSegmentSegmentIntersectionPoint(
				1.f, 1.f, 2.f, 2.f,
				1.f, 1.f, 3.f, 9.f));
