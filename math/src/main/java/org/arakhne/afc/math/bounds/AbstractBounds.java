 ...
 */
public abstract class AbstractBounds<P extends EuclidianPoint,PP,V> implements Bounds<P,PP,V> {
	...
	public Bounds<P,PP,V> clone() {
		try {
			return (Bounds<P,PP,V>)super.clone();
		}
		catch(Exception e) {
			throw new Error(e);
		}
