 ...
 */
public interface AlignedCombinableBounds<CB extends Bounds<P,PP,V>, P extends EuclidianPoint,PP,V>
extends AlignedBounds<P,PP,V>, CombinableBounds<CB,P,PP,V> {
