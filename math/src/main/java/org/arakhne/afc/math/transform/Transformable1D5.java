 ...
 */
public interface Transformable1D5<S extends Segment1D> {
     ...
     */
    public void setTransform(Transform1D5<S> trans);
     ...
     * @param trans is the transformation matrix
     */
    public void transform(Transform1D5<S> trans);
     ...
     */
    public Transform1D5<S> getTransformMatrix();

    /**
     * Set the position of the object.
     * 
     * @param curvilineCoord is the curviline position.
     * @param juttingCoord is the jutting position.
     */
     ...
     * @param juttingMove is the jutting translation.
     */
    public void translate(float curvilineMove, float juttingMove);
     ...
     */
    public void translate(Tuple2f<?> v);
     ...
     *
     * @param path is the path to follow.
     * @param v are translations. This values must be positive
     * to follow the path.
     */
    public void translate(List<? extends S> path, Tuple2f<?> v);
