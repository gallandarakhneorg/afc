 ...
 */
public interface Bounds<P extends EuclidianPoint, PP, V> extends Serializable, Cloneable {
	 ...
	 */
	public void getLowerUpper(PP lower, PP upper);
	...
	/** Replies the dimension of the space for this bounds.
	 * 
	 ...
	 */
	public float distance(PP reference);
	 ...
	 * @see #distance(Object)
	 */
	public float distanceSquared(PP reference);
	 ...
	 */
	public float distanceMax(PP reference);
	 ...
	 */
	public float distanceMaxSquared(PP reference);
	 ...
	 */
	public P nearestPoint(PP reference);
	 ...
	 */
	public P farestPoint(PP reference);
