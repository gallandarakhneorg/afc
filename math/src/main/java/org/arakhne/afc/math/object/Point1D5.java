 ...
 */
public class Point1D5 implements EuclidianPoint, Comparable<Point1D5> {
	 ...
	 * <p>
	 * The coordinate system used for this translation is replied
	 * by {@link CoordinateSystem2D#getDefaultCoordinateSystem()}.
	 * 
	 ...
	 */
	public final EuclidianPoint2D toPoint2D() {
	 ...
	 * <p>
	 * The coordinate system used for this translation is replied
	 * by {@link CoordinateSystem3D#getDefaultCoordinateSystem()}.
	 * 
	 * @return the 3D point which is corresponding to this 1D point or <code>null</code>
	 * if this point is not associated to a segment.
	 */
	public final EuclidianPoint3D toPoint3D() {
		return toPoint3D(CoordinateSystem3D.getDefaultCoordinateSystem());
	}

	/** Replies the 2D point which is corresponding to this 1D point.
	 * 
	 * @param system is the coordinate system to use for the translation.
	 * @return the 2D point which is corresponding to this 1D point or <code>null</code>
	 * if this point is not associated to a segment.
	 */
	public EuclidianPoint2D toPoint2D(CoordinateSystem2D system) {
		...
		if (sgmt!=null) {
			...
			sgmt.projectsOnPlane(this.curviline, this.jutting, position, null, system);
			return position;
		}
		return null;
	}
	...
	public EuclidianPoint3D toPoint3D(CoordinateSystem3D system) {
		...
		if (sgmt!=null) {
			EuclidianPoint2D position = new EuclidianPoint2D();
			sgmt.projectsOnPlane(this.curviline, this.jutting, position, null, system.toCoordinateSystem2D());
	...
	public int compareCoordinateTo(int coordinateIndex, float value) {
		...
		case 1:
			return Float.compare(this.jutting, value);
		}
	...
	public int compareCoordinateToEpsilon(int coordinateIndex, float value) {
		...
		case 1:
			return MathUtil.epsilonCompareToDistance(this.jutting, value);
		default:
			throw new IndexOutOfBoundsException(coordinateIndex+">=2"); //$NON-NLS-1$
		}
	}
