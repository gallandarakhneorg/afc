...
import org.arakhne.afc.math.unit.SpeedUnit;
...
public interface LinearAccelerationKinematic extends LinearVelocityKinematic, LinearInstantAccelerationKinematic {
	 ...
	 * always >=0.
	 */
	public float getMaxLinearAcceleration(SpeedUnit unit);
	 ...
	 * always >=0.
	 */
	public float getMaxLinearDeceleration();
	 ...
	 * always >=0.
	 */
	public float getMaxLinearDeceleration(SpeedUnit unit);
