...
/**
 * This interface represents a point in an euclidian line, area or space.
 * 
 ...
 */
public interface EuclidianPoint extends Cloneable, Serializable {
     ...
     * <p>
     * This function uses {@link Double#compare(float, float)}
	...
	/** Set the value of the coordinate at the given index.
	 * 
     * @param coordinateIndex is the index of the coordinate to compare to.
     * This index is between {@code 0} and the coordinate count given by
     * {@link #getMathematicalDimension()}.
	 * @param value is the coordinate's value.
	 */
	 ...
	 * they are set to {@link Double#NaN}.
	 * 
