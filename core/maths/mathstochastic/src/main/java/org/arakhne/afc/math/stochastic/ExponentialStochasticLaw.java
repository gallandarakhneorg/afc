...
public class ExponentialStochasticLaw extends StochasticLaw {
	 ...
	 */
	@Pure
	@Inline(value = "StochasticGenerator.generateRandomValue(new ExponentialStochasticLaw(($1), ($2)))",
		imported = {StochasticGenerator.class, ExponentialStochasticLaw.class})
	...
	public void toJson(JsonBuffer buffer) {
		...
		buffer.add(LAMBDA_NAME, Double.valueOf(this.lambda));
		buffer.add(XMIN_NAME, Double.valueOf(this.xmin));
	}
