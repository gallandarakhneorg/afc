...
class ClosestPointPathShadow2afp {
    ...
    private final Point2D<?, ?> otherShapeClosestPoint = new InnerComputationPoint2D();

    private final Point2D<?, ?> shadowShapeClosestPoint = new InnerComputationPoint2D();

    private final Point2D<?, ?> temporaryPoint1 = new InnerComputationPoint2D();

    private final Point2D<?, ?> temporaryPoint2 = new InnerComputationPoint2D();
