 ...
 * @since 13.0
 */
public class InnerComputationVector1D implements Vector1D<InnerComputationVector1D,
		InnerComputationPoint1D, Segment1D<?, ?>> {
	 ...
	 */
	public InnerComputationVector1D(Segment1D<?, ?> segment) {
		this(segment, 0, 0);
	}
	 ...
	 */
	public InnerComputationVector1D(Segment1D<?, ?> segment, double x, double y) {
	...
	@Override
	public InnerComputationGeomFactory1D getGeomFactory() {
	...
	@Override
	public InnerComputationVector1D clone() {
		try {
			return (InnerComputationVector1D) super.clone();
	...
	@Override
	public UnmodifiableVector1D<InnerComputationVector1D, InnerComputationPoint1D, Segment1D<?, ?>> toUnmodifiable() {
