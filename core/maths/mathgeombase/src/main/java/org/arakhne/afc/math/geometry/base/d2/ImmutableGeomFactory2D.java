 ...
 * @since 13.0
 */
public final class ImmutableGeomFactory2D extends AbstractGeomFactory2D<ImmutableVector2D, ImmutablePoint2D> {

	/** Singleton of the factory.
	 */
	public static final ImmutableGeomFactory2D SINGLETON = new ImmutableGeomFactory2D();

	/** Constructor, but prefer to use the {@link #SINGLETON singleton}.
	 */
	public ImmutableGeomFactory2D() {
		//
	}
