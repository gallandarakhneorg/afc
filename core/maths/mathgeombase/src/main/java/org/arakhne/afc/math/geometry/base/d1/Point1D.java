...
public interface Point1D<RP extends Point1D<? super RP, ? super RV, ? super RS>,
	...
	extends Tuple1D<RP, RV, RP, RS>, Comparable<Point1D<?, ?, ?>> {
	 ...
	 */
	@Pure
	UnmodifiablePoint1D<?, ?, RS> toUnmodifiable();
	 ...
	 * {@link org.arakhne.afc.math.geometry.base.extensions.scala.Tuple2DExtensions#$plus(double, Point2D)}.
	 *
	 * @param scalar the scalar
	 * @return the result.
	 * @see org.arakhne.afc.math.geometry.base.extensions.scala.Tuple2DExtensions#$plus(double, Point2D)
	 */
	@Pure
	@ScalaOperator("+")
	@Inline("operator_plus($1)")
	 ...
	 * {@link org.arakhne.afc.math.geometry.base.extensions.scala.Tuple2DExtensions#$minus(double, Point2D)}.
	 *
	 * @param scalar the scalar.
	 * @return the result.
	 * @see org.arakhne.afc.math.geometry.base.extensions.scala.Tuple2DExtensions#$minus(double, Point2D)
	 */
	@Pure
	@ScalaOperator("-")
	@Inline("operator_minus($1)")
