 ...
 * The comparator compares the x-coordinates and, if they are equal, compares the y-coordinates.
 *
 ...
 */
public class Tuple2DComparator implements Comparator<Tuple2D<?>> {

	/** Construct a comparator.
	 */
	public Tuple2DComparator() {
		//
	}
	...
	public int compare(Tuple2D<?> tuple1, Tuple2D<?> tuple2) {
		...
		final var cmp = Double.compare(tuple1.getX(), tuple2.getX());
		if (cmp != 0) {
			return cmp;
		}
