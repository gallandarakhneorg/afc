...
public class Transform1D<S extends Segment1D<?, ?>> {
	 ...
	 *
	 * <p>The algorithm interprets a motion along the directed {@code segment} as a combination of two independent 1D movements:
	 * <ul>
	 * <li>a curvilinear translation <math><msub><mi>t</mi><mi>x</mi></msub></math> (distance traveled along the segment direction),</li>
	 * <li>a perpendicular shift <math><msub><mi>t</mi><mi>y</mi></msub></math> (distance shifted to the left when looking
	 * from start point to end point.</li>
	 * </ul>
	 * These two scalar components are combined into a single 2D translation vector
	 * <math><mi mathvariant="bold">r</mi></math> that can be applied to any point in the plane.
	 *
	 * <h3>Mathematical formulation</h3>
	 * Given points <math><mi>A</mi></math> (start) and <math><mi>B</mi></math> (end) in <math><msup><mi>ℝ</mi><mn>2</mn></msup></math>:
	 * <ol>
	 *   <li>Direction vector from <math><mi>A</mi></math> to <math><mi>B</mi></math>:
	 *       <br/><math><mrow><mover><mi>AB</mi><mo stretchy="false">→</mo></mover><mo>=</mo><mi>B</mi><mo>-</mo><mi>A</mi></mrow></math></li>
	 *   <li>Length of the segment:
	 *       <br/><math><mrow><mi>L</mi><mo>=</mo><mo>∥</mo><mover><mi>AB</mi><mo stretchy="false">→</mo></mover>
	 *       <mo>∥</mo><mo>=</mo><msqrt><msup><mi>Δx</mi><mn>2</mn></msup><mo>+</mo><msup><mi>Δy</mi><mn>2</mn></msup></msqrt></mrow></math></li>
	 *   <li>Unit direction vector (tangent to the segment):
	 *       <br/><math><mrow><mi mathvariant="bold">V</mi><mo>=</mo><mfrac><mover><mi>AB</mi><mo stretchy="false">→</mo></mover>
	 *       <mi>L</mi></mfrac><mo>=</mo><mo>(</mo><msub><mi>V</mi><mi>x</mi></msub><mo>,</mo><msub><mi>V</mi>
	 *       <mi>y</mi></msub><mo>)</mo></mrow></math></li>
	 *   <li>Unit perpendicular vector (90° counter‑clockwise rotation of <math><mi mathvariant="bold">V</mi></math>):
	 *       <br/><math><mrow><mi mathvariant="bold">P</mi><mo>=</mo><mo>(</mo><mo>-</mo><msub><mi>V</mi><mi>y</mi></msub><mo>,</mo>
	 *       <msub><mi>V</mi><mi>x</mi></msub><mo>)</mo></mrow></math></li>
	 *   <li>Finally, the 2D translation vector is the linear combination:
	 *       <br/><math><mrow><mi mathvariant="bold">r</mi><mo>=</mo><msub><mi>t</mi><mi>x</mi></msub><mo>·</mo>
	 *       <mi mathvariant="bold">V</mi><mo>+</mo><msub><mi>t</mi><mi>y</mi></msub><mo>·</mo><mi mathvariant="bold">P</mi></mrow></math></li>
	 * </ol>
	 *
	 * <p>The resulting vector <math><mi mathvariant="bold">r</mi></math> shifts any point exactly as if it had moved
	 * a distance <math><msub><mi>t</mi><mi>x</mi></msub></math> along the segment direction and then a distance
	 * <math><msub><mi>t</mi><mi>y</mi></msub></math> perpendicularly to it (order does not matter because the two components
	 * are orthogonal).
	 *
	 ...
	 * <p>The used coordinate system is replied by {@link CoordinateSystem2D#getDefaultCoordinateSystem()}.
	 *
	 * <p>The algorithm interprets a motion along a directed segment from {@code startPoint} to
	 * {@code endPoint} as a combination of two independent 1D movements:
	 * <ul>
	 * <li>a curvilinear translation <math><msub><mi>t</mi><mi>x</mi></msub></math> (distance traveled along the segment direction),</li>
	 * <li>a perpendicular shift <math><msub><mi>t</mi><mi>y</mi></msub></math> (distance shifted to the left when looking
	 * from start point to end point.</li>
	 ...
	 * <p>The used coordinate system is replied by {@link CoordinateSystem2D#getDefaultCoordinateSystem()}.
	 *
	 * <p>The algorithm interprets a motion along a directed segment from {@code (startX, starty)} to
	 * {@code (endX, endY)} as a combination of two independent 1D movements:
	 * <ul>
	 * <li>a curvilinear translation <math><msub><mi>t</mi><mi>x</mi></msub></math> (distance traveled along the segment direction),</li>
	 * <li>a perpendicular shift <math><msub><mi>t</mi><mi>y</mi></msub></math> (distance shifted to the left when looking
	 * from start point to end point.</li>
	...
	public final Transform2D toTransform2D(double startX, double startY, double endX, double endY) {
		...
		final var direction = new InnerComputationVector2D(endX - startX, endY - startY);
		direction.normalize();
