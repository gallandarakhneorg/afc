...
public class Matrix2d implements Serializable, Cloneable {
	 ...
	 * @return {@code true} if the covariance matrix could be computed.
	 */
	 ...
	 * {@link org.arakhne.afc.math.geometry.base.extensions.scala.MatrixExtensions#$plus(double, Matrix2d)}.
	 *
	 * @param scalar the scalar.
	 * @return the sum of the matrix and the scalar.
	 * @see #add(double)
	 * @see org.arakhne.afc.math.geometry.base.extensions.scala.MatrixExtensions#$plus(double, Matrix2d)
	 */
	@Pure
	@ScalaOperator("+")
	 ...
	 *
	 * <p>The operation {@code scalar - this} is supported by
	 * {@link org.arakhne.afc.math.geometry.base.extensions.scala.MatrixExtensions#$minus(double, Matrix2d)}.
	 *
	 * @param scalar the scalar.
	 * @return the result of the substraction.
	 * @see #add(double)
	 * @see org.arakhne.afc.math.geometry.base.extensions.scala.MatrixExtensions#$minus(double, Matrix2d)
	 */
	@Pure
	@ScalaOperator("-")
	 ...
	 * @return the multiplication of the scalar and the matrix.
	 * @see #mul(Matrix2d)
	 * @see org.arakhne.afc.math.geometry.base.extensions.scala.MatrixExtensions#$times(double, Matrix2d)
	 */
	@Pure
	@ScalaOperator("*")
	 ...
	 * @return the division of the matrix by the scalar.
	 * @see #mul(double)
	 * @see org.arakhne.afc.math.geometry.base.extensions.scala.MatrixExtensions#$div(double, Matrix2d)
	 */
	@Pure
	@ScalaOperator("/")
	...
	public String toGnuOctave() {
		return GnuOctaveUtil.toMatrixDefinition(2,
				getM00(), getM01(),
				getM10(), getM11());
	}
