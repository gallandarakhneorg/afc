...
public final class MatrixExtensions {
    ...
    public static <M extends Matrix2d> M $plus(double left, M right) {
        return org.arakhne.afc.math.geometry.base.extensions.xtext.MatrixExtensions.operator_plus(left, right);
    }
    ...
    public static <M extends Matrix2d> M $minus(double left, M right) {
        return org.arakhne.afc.math.geometry.base.extensions.xtext.MatrixExtensions.operator_minus(left, right);
    }
    ...
    public static <M extends Matrix2d> M $times(double left, M right) {
        return org.arakhne.afc.math.geometry.base.extensions.xtext.MatrixExtensions.operator_multiply(left, right);
    }
    ...
    public static <M extends Matrix2d> M $div(double left, M right) {
        return org.arakhne.afc.math.geometry.base.extensions.xtext.MatrixExtensions.operator_divide(left, right);
    }
