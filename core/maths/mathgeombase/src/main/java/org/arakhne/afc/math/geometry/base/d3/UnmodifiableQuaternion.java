 ...
 * @since 18.0
 */
public interface UnmodifiableQuaternion<RP extends Point3D<? super RP, ? super RV, ? super RQ>,
		RV extends Vector3D<? super RV, ? super RP, ? super RQ>,
		RQ extends Quaternion<? super RP, ? super RV, ? super RQ>>
		extends Quaternion<RP, RV, RQ> {
	...
	@Override
	default UnmodifiableQuaternion<?, ?, ?> toUnmodifiable() {
		return this;
	}
