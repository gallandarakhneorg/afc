 ...
 */
public final class ImmutableGeomFactory3D extends AbstractGeomFactory3D<ImmutableVector3D, ImmutablePoint3D, ImmutableQuaternion> {
	...
	@Override
	public ImmutableQuaternion newQuaternion(double x, double y, double z, double w) {
		return new ImmutableQuaternion(x, y, z, w);
	}

	@Override
	public ImmutableQuaternion newQuaternion(int x, int y, int z, int w) {
		return new ImmutableQuaternion(x, y, z, w);
	}

	@Override
	public ImmutableQuaternion newQuaternionFromAxisAngle(double x, double y, double z, double angle) {
		return new ImmutableQuaternion(new AxisAngle(x, y, z, angle, null));
	}

	@Override
	public ImmutableQuaternion newQuaternionFromAxisAngle(int x, int y, int z, int angle) {
		return new ImmutableQuaternion(new AxisAngle(x, y, z, angle, null));
	}
