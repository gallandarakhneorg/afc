 ...
 * @since 18.0
 */
public class InnerComputationPoint3D implements Point3D<InnerComputationPoint3D, InnerComputationVector3D, InnerComputationQuaternion> {

	private static final long serialVersionUID = 6582146961626109439L;
	...
	/** Construct the point.
	 */
	public InnerComputationPoint3D() {
		//
	}
	 ...
	 */
	public InnerComputationPoint3D(double x, double y, double z) {
		this.x = x;
		this.y = y;
		this.z = z;
	}
	 ...
	 */
	public InnerComputationPoint3D(Tuple3D<?> tuple) {
		this.x = tuple.getX();
		this.y = tuple.getY();
		this.z = tuple.getZ();
	}
	...
	@Override
	public InnerComputationPoint3D clone() {
		try {
			return (InnerComputationPoint3D) super.clone();
	...
	@Override
	public UnmodifiablePoint3D<InnerComputationPoint3D, InnerComputationVector3D, InnerComputationQuaternion> toUnmodifiable() {
