...
public interface Vector2D<RV extends Vector2D<? super RV, ? super RP>, RP extends Point2D<? super RP, ? super RV>>
	 ...
	 */
	@Pure
	UnmodifiableVector2D<?, ?> toUnmodifiable();
	 ...
	 * {@link org.arakhne.afc.math.geometry.base.extensions.scala.Tuple2DExtensions#$times(double, Vector2D)}.
	 *
	 * @param factor the scaling factor.
	 * @return the scaled vector.
	 * @see #scale(double)
	 * @see org.arakhne.afc.math.geometry.base.extensions.scala.Tuple2DExtensions#$times(double, Vector2D)
	 */
	@Pure
	@ScalaOperator("*")
	@Inline("operator_multiply($1)")
	 ...
	 * {@link org.arakhne.afc.math.geometry.base.extensions.scala.Tuple2DExtensions#$minus(double, Vector2D)}.
	 *
	 * @param scalar the scalar.
	 * @return the result.
	 * @see #sub(Vector2D)
	 * @see org.arakhne.afc.math.geometry.base.extensions.scala.Tuple2DExtensions#$minus(double, Vector2D)
	 */
	@Pure
	@ScalaOperator("-")
	@Inline("operator_minus($1)")
	 ...
	 *
	 * <p>The operation {@code scalar / this} is supported by
	 * {@link org.arakhne.afc.math.geometry.base.extensions.scala.Tuple2DExtensions#$div(double, Vector2D)}.
	 *
	 * @param factor the scaling factor
	 * @return the scaled vector.
	 * @see org.arakhne.afc.math.geometry.base.extensions.scala.Tuple2DExtensions#$div(double, Vector2D)
	 */
	@Pure
	@ScalaOperator("/")
	 ...
	 *
	 * <p>The operation {@code scalar + this} is supported by
	 * {@link org.arakhne.afc.math.geometry.base.extensions.scala.Tuple2DExtensions#$plus(double, Vector2D)}.
	 *
	 * @param scalar the scalar.
	 * @return the result.
	 * @see #add(Vector2D, Vector2D)
	 * @see org.arakhne.afc.math.geometry.base.extensions.scala.Tuple2DExtensions#$plus(double, Vector2D)
	 */
	@Pure
	@ScalaOperator("+")
	@Inline("operator_plus($1)")
