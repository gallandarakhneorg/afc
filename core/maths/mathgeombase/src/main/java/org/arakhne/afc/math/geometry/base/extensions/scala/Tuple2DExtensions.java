...
package org.arakhne.afc.math.geometry.base.extensions.scala;
...
public final class Tuple2DExtensions {
	...
	public static <V extends Vector2D<V, ?>> V $times(double left, V right) {
		return org.arakhne.afc.math.geometry.base.extensions.xtext.Tuple2DExtensions.operator_multiply(left, right);
	}
	...
	public static <V extends Vector2D<V, ?>> V $div(double left, V right) {
		return org.arakhne.afc.math.geometry.base.extensions.xtext.Tuple2DExtensions.operator_divide(left, right);
	}
	...
	public static <V extends Vector2D<V, ?>> V $minus(double left, V right) {
		return org.arakhne.afc.math.geometry.base.extensions.xtext.Tuple2DExtensions.operator_minus(left, right);
	}
	...
	public static <V extends Vector2D<V, ?>> V $plus(double left, V right) {
		return org.arakhne.afc.math.geometry.base.extensions.xtext.Tuple2DExtensions.operator_plus(left, right);
