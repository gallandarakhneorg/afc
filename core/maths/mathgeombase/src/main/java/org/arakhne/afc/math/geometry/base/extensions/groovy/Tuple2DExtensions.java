...
public final class Tuple2DExtensions {
	 ...
	 * @see Vector2D#multiply(double)
	 */
	@Pure
	@GroovyOperator("*")
	public static <V extends Vector2D<V, ?>> V multiply(double left, V right) {
	...
	@Pure
	@GroovyOperator("*")
	public static <V extends Vector1D<V, ?, ?>> V multiply(double left, V right) {
		assert right != null : AssertMessages.notNullParameter(1);
