 ...
 * @since 18.0
 */
public interface TransformableShape3afp<
		ST extends Shape3afp<?, IE, P, V, Q, B>,
		IT extends TransformableShape3afp<?, ?, IE, P, V, Q, B>,
		IE extends PathElement3afp,
		P extends Point3D<? super P, ? super V, ? super Q>,
		V extends Vector3D<? super V, ? super P, ? super Q>,
		Q extends Quaternion<? super P, ? super V, ? super Q>,
		B extends AlignedBox3afp<?, IE, P, V, Q, B>>
		extends TransformableShape3D<ST, IT, PathIterator3afp<IE>, P, V, Q, B>, Shape3afp<IT, IE, P, V, Q, B> {
