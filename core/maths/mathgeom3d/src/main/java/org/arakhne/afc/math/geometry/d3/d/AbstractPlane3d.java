...
public abstract class AbstractPlane3d<T extends AbstractPlane3d<T>>
	...
	private static final long serialVersionUID = 2620436745780463367L;

	private List<PlaneGeometryChangeListener> geometryListeners;

	/** Add listener on geometry changes.
	 *
	 * @param listener the listener.
	 */
	protected synchronized void addPlaneGeometryChangeListener(PlaneGeometryChangeListener listener) {
	 ...
	 * @param listener the listener.
	 */
	protected synchronized void removePlaneGeometryChangeListener(PlaneGeometryChangeListener listener) {
		assert listener != null : AssertMessages.notNullParameter();
		if (this.geometryListeners != null) {
	...
	protected synchronized void fireGeometryChange() {
		...
		final var array = new PlaneGeometryChangeListener[this.geometryListeners.size()];
