...
@DisplayName("Shape3DType")
public class Shape3DTypeTest {

	@DisplayName("getPreferredContinuousShapeType")
	@Nested
	public class GetPreferredContinuousShapeType {

		@Test
		@DisplayName("ALIGNED_BOX")
	...
	@DisplayName("getPreferredDiscreteShapeType")
	@Nested
	public class GetPreferredDiscreteShapeType {
