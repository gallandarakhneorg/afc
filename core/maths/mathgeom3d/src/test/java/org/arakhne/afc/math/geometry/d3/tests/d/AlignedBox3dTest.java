...
import org.arakhne.afc.math.geometry.d3.tests.afp.AbstractAlignedBox3dTestCase;
...
@DisplayName("AlignedBox3d")
public class AlignedBox3dTest extends AbstractAlignedBox3dTestCase<AlignedBox3d, AlignedBox3d> {
	...
	@Override
	@Test
	public void intersectsMultiShape3D(CoordinateSystem3D cs) {
		throw new UnsupportedOperationException();
	}
