...
public class Plane3dTest extends AbstractMathTestCase {
	...
	@ParameterizedTest(name = "{index} => {0}")
	@EnumSource(CoordinateSystem3D.class)
	public void intersectsPlane3D(CoordinateSystem3D cs) {
		CoordinateSystem3D.setDefaultCoordinateSystem(cs);

		assertTrue(this.plane.intersects(new Plane3d(A, B, C, D)));
		assertTrue(this.plane.intersects(new Plane3d(NORMAL_X, NORMAL_Y, NORMAL_Z, D)));
		assertTrue(this.plane.intersects(new Plane3d(-NORMAL_X, -NORMAL_Y, -NORMAL_Z, -D)));
		assertFalse(this.plane.intersects(new Plane3d(NORMAL_X, NORMAL_Y, NORMAL_Z, D + 1)));
		assertTrue(this.plane.intersects(new Plane3d(1., 2., 0., 5.)));
	...
	public void operator_addDouble(CoordinateSystem3D cs) {
		CoordinateSystem3D.setDefaultCoordinateSystem(cs);
		this.plane.operator_add(7);
		assertEpsilonEquals(NORMAL_X, this.plane.getEquationComponentA());
		assertEpsilonEquals(NORMAL_Y, this.plane.getEquationComponentB());
		assertEpsilonEquals(NORMAL_Z, this.plane.getEquationComponentC());
		assertEpsilonEquals(11, this.plane.getEquationComponentD());
		//
		this.plane.operator_add(-25);
		assertEpsilonEquals(NORMAL_X, this.plane.getEquationComponentA());
		assertEpsilonEquals(NORMAL_Y, this.plane.getEquationComponentB());
		assertEpsilonEquals(NORMAL_Z, this.plane.getEquationComponentC());
		assertEpsilonEquals(-14, this.plane.getEquationComponentD());
	...
	public void operator_addVector3D(CoordinateSystem3D cs) {
		CoordinateSystem3D.setDefaultCoordinateSystem(cs);
		this.plane.operator_add(createVector(1, 2, 3));
		assertEpsilonEquals(NORMAL_X, this.plane.getEquationComponentA());
		assertEpsilonEquals(NORMAL_Y, this.plane.getEquationComponentB());
		assertEpsilonEquals(NORMAL_Z, this.plane.getEquationComponentC());
		assertEpsilonEquals(1.1422619667529594, this.plane.getEquationComponentD());
	...
	@ParameterizedTest(name = "{index} => {0}")
	@EnumSource(CoordinateSystem3D.class)
	public void operator_andPlane3D(CoordinateSystem3D cs) {
		CoordinateSystem3D.setDefaultCoordinateSystem(cs);

		assertTrue(this.plane.operator_and(new Plane3d(A, B, C, D)));
		assertTrue(this.plane.operator_and(new Plane3d(NORMAL_X, NORMAL_Y, NORMAL_Z, D)));
		assertTrue(this.plane.operator_and(new Plane3d(-NORMAL_X, -NORMAL_Y, -NORMAL_Z, -D)));
		assertFalse(this.plane.operator_and(new Plane3d(NORMAL_X, NORMAL_Y, NORMAL_Z, D + 1)));
		assertTrue(this.plane.operator_and(new Plane3d(1., 2., 0., 5.)));
	...
	public void operator_andPoint3D(CoordinateSystem3D cs) {
		CoordinateSystem3D.setDefaultCoordinateSystem(cs);
		assertFalse(this.plane.operator_and(createPoint(0, 0, 0)));
		assertTrue(this.plane.operator_and(createPoint(-3.2659863237109046, -1.6329931618554523, -1.6329931618554523)));
		assertFalse(this.plane.operator_and(createPoint(-8, -4, -4)));
		//
		this.plane.negate();
		assertFalse(this.plane.operator_and(createPoint(0, 0, 0)));
		assertTrue(this.plane.operator_and(createPoint(-3.2659863237109046, -1.6329931618554523, -1.6329931618554523)));
	...
	@ParameterizedTest(name = "{index} => {0}")
	@EnumSource(CoordinateSystem3D.class)
	public void operator_equalsPlane3D(CoordinateSystem3D cs) {
		CoordinateSystem3D.setDefaultCoordinateSystem(cs);

		assertTrue(this.plane.operator_equals(new Plane3d(A, B, C, D)));
		assertTrue(this.plane.operator_equals(new Plane3d(NORMAL_X, NORMAL_Y, NORMAL_Z, D)));
		assertFalse(this.plane.operator_equals(new Plane3d(-NORMAL_X, -NORMAL_Y, -NORMAL_Z, -D)));
		assertFalse(this.plane.operator_equals(new Plane3d(NORMAL_X, NORMAL_Y, NORMAL_Z, D + 1)));
		assertFalse(this.plane.operator_equals(new Plane3d(1., 2., 0., 5.)));

		//
		this.plane.negate();

		assertFalse(this.plane.operator_equals(new Plane3d(A, B, C, D)));
		assertFalse(this.plane.operator_equals(new Plane3d(NORMAL_X, NORMAL_Y, NORMAL_Z, D)));
		assertTrue(this.plane.operator_equals(new Plane3d(-NORMAL_X, -NORMAL_Y, -NORMAL_Z, -D)));
		assertFalse(this.plane.operator_equals(new Plane3d(NORMAL_X, NORMAL_Y, NORMAL_Z, D + 1)));
		assertFalse(this.plane.operator_equals(new Plane3d(1., 2., 0., 5.)));
	...
	@ParameterizedTest(name = "{index} => {0}")
	@EnumSource(CoordinateSystem3D.class)
	public void testEqualsPlane3D(CoordinateSystem3D cs) {
		CoordinateSystem3D.setDefaultCoordinateSystem(cs);

		assertTrue(this.plane.equals(new Plane3d(A, B, C, D)));
		assertTrue(this.plane.equals(new Plane3d(NORMAL_X, NORMAL_Y, NORMAL_Z, D)));
		assertFalse(this.plane.equals(new Plane3d(-NORMAL_X, -NORMAL_Y, -NORMAL_Z, -D)));
		assertFalse(this.plane.equals(new Plane3d(NORMAL_X, NORMAL_Y, NORMAL_Z, D + 1)));
		assertFalse(this.plane.equals(new Plane3d(1., 2., 0., 5.)));

		//
		this.plane.negate();

		assertFalse(this.plane.equals(new Plane3d(A, B, C, D)));
		assertFalse(this.plane.equals(new Plane3d(NORMAL_X, NORMAL_Y, NORMAL_Z, D)));
		assertTrue(this.plane.equals(new Plane3d(-NORMAL_X, -NORMAL_Y, -NORMAL_Z, -D)));
		assertFalse(this.plane.equals(new Plane3d(NORMAL_X, NORMAL_Y, NORMAL_Z, D + 1)));
		assertFalse(this.plane.equals(new Plane3d(1., 2., 0., 5.)));
	...
	public void operator_minusDouble(CoordinateSystem3D cs) {
		...
		//
		p = this.plane.operator_minus(25);
		assertNotSame(this.plane, p);
		assertEpsilonEquals(NORMAL_X, this.plane.getEquationComponentA());
		assertEpsilonEquals(NORMAL_Y, this.plane.getEquationComponentB());
		assertEpsilonEquals(NORMAL_Z, this.plane.getEquationComponentC());
	...
	public void operator_minusVector3D(CoordinateSystem3D cs) {
		...
		p = this.plane.operator_minus(createVector(-1, -2, -3));
		assertNotSame(this.plane, p);
		assertEpsilonEquals(NORMAL_X, this.plane.getEquationComponentA());
		assertEpsilonEquals(NORMAL_Y, this.plane.getEquationComponentB());
		assertEpsilonEquals(NORMAL_Z, this.plane.getEquationComponentC());
	...
	@ParameterizedTest(name = "{index} => {0}")
	@EnumSource(CoordinateSystem3D.class)
	public void operator_multiplyQuaternion(CoordinateSystem3D cs) {
		CoordinateSystem3D.setDefaultCoordinateSystem(cs);
		Plane3d p;
		...
		p = this.plane.operator_multiply(q);
	...
	public void operator_multiplyTransform3D(CoordinateSystem3D cs) {
		...
		p = this.plane.operator_multiply(transform);
	...
	@ParameterizedTest(name = "{index} => {0}")
	@EnumSource(CoordinateSystem3D.class)
	public void operator_notEqualsPlane3D(CoordinateSystem3D cs) {
		CoordinateSystem3D.setDefaultCoordinateSystem(cs);

		assertFalse(this.plane.operator_notEquals(new Plane3d(A, B, C, D)));
		assertFalse(this.plane.operator_notEquals(new Plane3d(NORMAL_X, NORMAL_Y, NORMAL_Z, D)));
		assertTrue(this.plane.operator_notEquals(new Plane3d(-NORMAL_X, -NORMAL_Y, -NORMAL_Z, -D)));
		assertTrue(this.plane.operator_notEquals(new Plane3d(NORMAL_X, NORMAL_Y, NORMAL_Z, D + 1)));
		assertTrue(this.plane.operator_notEquals(new Plane3d(1., 2., 0., 5.)));

		//
		this.plane.negate();

		assertTrue(this.plane.operator_notEquals(new Plane3d(A, B, C, D)));
		assertTrue(this.plane.operator_notEquals(new Plane3d(NORMAL_X, NORMAL_Y, NORMAL_Z, D)));
		assertFalse(this.plane.operator_notEquals(new Plane3d(-NORMAL_X, -NORMAL_Y, -NORMAL_Z, -D)));
		assertTrue(this.plane.operator_notEquals(new Plane3d(NORMAL_X, NORMAL_Y, NORMAL_Z, D + 1)));
		assertTrue(this.plane.operator_notEquals(new Plane3d(1., 2., 0., 5.)));
	...
	public void operator_plusVector3D(CoordinateSystem3D cs) {
		...
		p = this.plane.operator_plus(createVector(1, 2, 3));
		assertNotSame(this.plane, p);
		assertEpsilonEquals(NORMAL_X, this.plane.getEquationComponentA());
		assertEpsilonEquals(NORMAL_Y, this.plane.getEquationComponentB());
		assertEpsilonEquals(NORMAL_Z, this.plane.getEquationComponentC());
	...
	public void operator_removeDouble(CoordinateSystem3D cs) {
		CoordinateSystem3D.setDefaultCoordinateSystem(cs);
		this.plane.operator_remove(-7);
		assertEpsilonEquals(NORMAL_X, this.plane.getEquationComponentA());
		assertEpsilonEquals(NORMAL_Y, this.plane.getEquationComponentB());
		assertEpsilonEquals(NORMAL_Z, this.plane.getEquationComponentC());
		assertEpsilonEquals(11, this.plane.getEquationComponentD());
		//
		this.plane.operator_remove(25);
		assertEpsilonEquals(NORMAL_X, this.plane.getEquationComponentA());
		assertEpsilonEquals(NORMAL_Y, this.plane.getEquationComponentB());
		assertEpsilonEquals(NORMAL_Z, this.plane.getEquationComponentC());
		assertEpsilonEquals(-14, this.plane.getEquationComponentD());
	...
	public void operator_removeVector3D(CoordinateSystem3D cs) {
		CoordinateSystem3D.setDefaultCoordinateSystem(cs);
		this.plane.operator_remove(createVector(-1, -2, -3));
		assertEpsilonEquals(NORMAL_X, this.plane.getEquationComponentA());
		assertEpsilonEquals(NORMAL_Y, this.plane.getEquationComponentB());
		assertEpsilonEquals(NORMAL_Z, this.plane.getEquationComponentC());
		assertEpsilonEquals(1.1422619667529594, this.plane.getEquationComponentD());
	...
	public void operator_upToPlane3D(CoordinateSystem3D cs) {
		CoordinateSystem3D.setDefaultCoordinateSystem(cs);
		assertEpsilonEquals(0., this.plane.operator_upTo(new Plane3d(A, B, C, D)));
		assertEpsilonEquals(0., this.plane.operator_upTo(new Plane3d(NORMAL_X, NORMAL_Y, NORMAL_Z, D)));
		assertEpsilonEquals(0., this.plane.operator_upTo(new Plane3d(-NORMAL_X, -NORMAL_Y, -NORMAL_Z, -D)));
		assertEpsilonEquals(18., this.plane.operator_upTo(new Plane3d(NORMAL_X, NORMAL_Y, NORMAL_Z, D + 18)));
		assertEpsilonEquals(18., this.plane.operator_upTo(new Plane3d(-NORMAL_X, -NORMAL_Y, -NORMAL_Z, -D + 18)));
		//
		assertEpsilonEquals(0., this.plane.operator_upTo(new Plane3d(NORMAL_X - 1, NORMAL_Y, NORMAL_Z, D)));
		assertEpsilonEquals(0., this.plane.operator_upTo(new Plane3d(NORMAL_X, NORMAL_Y - 1, NORMAL_Z, D)));
		assertEpsilonEquals(0., this.plane.operator_upTo(new Plane3d(NORMAL_X, NORMAL_Y, NORMAL_Z - 1, D)));
	}
	...
	public void operator_upToPoint3D(CoordinateSystem3D cs) {
		CoordinateSystem3D.setDefaultCoordinateSystem(cs);
		assertEpsilonEquals(4, this.plane.operator_upTo(createPoint(0, 0, 0)));
		assertEpsilonEquals(-2.94022093788, this.plane.operator_upTo(createPoint(-5, -7, 0)));
		assertEpsilonEquals(5.6329931618, this.plane.operator_upTo(createPoint(-1, 8, -2)));
		this.plane.negate();
		assertEpsilonEquals(-4, this.plane.operator_upTo(createPoint(0, 0, 0)));
		assertEpsilonEquals(2.940220937885, this.plane.operator_upTo(createPoint(-5, -7, 0)));
		assertEpsilonEquals(-5.6329931618, this.plane.operator_upTo(createPoint(-1, 8, -2)));
	}
