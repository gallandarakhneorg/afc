...
/** 3D Point with 2 integer numbers.
 *
 ...
 * @since 13.0
 */
public class Point3i extends Tuple3i<Point3i> implements Point3D<Point3i, Vector3i, Quaternion4i> {
	...
	public double getDistanceSquared(Point3D<?, ?, ?> point) {
		...
		final var dz = this.z - point.getZ();
	...
	@Pure
	@Override
	public UnmodifiablePoint3D<Point3i, Vector3i, Quaternion4i> toUnmodifiable() {
