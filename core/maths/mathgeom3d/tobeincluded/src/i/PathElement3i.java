...
public abstract class PathElement3i implements PathElement3ai {
    ...
    static class MovePathElement3i extends PathElement3i {
        ...
        public boolean equals(Object obj) {
            try {
                final var elt = (PathElement3ai) obj;
    ...
    static class CurvePathElement3i extends PathElement3i {
        ...
        public boolean isEmpty() {
            return this.fromX == this.toX && this.fromY == this.toY && this.ctrlX1 == this.toX
            		&& this.ctrlY1 == this.toY && this.ctrlZ1 == this.toZ && this.ctrlX2 == this.toX
            		&& this.ctrlY2 == this.toY && this.ctrlZ2 == this.toZ;
        }
