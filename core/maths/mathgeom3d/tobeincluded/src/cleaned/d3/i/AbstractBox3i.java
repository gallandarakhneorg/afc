 ...
 * @since 14.0
 */
public abstract class AbstractBox3i<IT extends AbstractBox3i<?>>
	extends AbstractShape3i<IT>
	implements Box3ai<IT, PathElement3i, Point3i, Vector3i, Quaternion4i, AlignedBox3i> {
	 ...
	 */
	public AbstractBox3i(Box3ai<?, ?, ?, ?, ?, ?> shape) {
