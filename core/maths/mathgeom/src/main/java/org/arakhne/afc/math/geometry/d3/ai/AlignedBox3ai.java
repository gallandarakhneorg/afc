...
public interface AlignedBox3ai<
	...
	/** Replies if a aligned box is intersecting a segment.
	 *
	 ...
	 * detection.
	 *
	 * @param x1 is the first corner of the aligned box.
	 * @param y1 is the first corner of the aligned box.
	 * @param z1 is the first corner of the aligned box.
	 * @param x2 is the second corner of the aligned box.
	 * @param y2 is the second corner of the aligned box.
	 * @param z2 is the second corner of the aligned box.
	 ...
	 *
	 * @param minx is the x-coordinate of the lowest coordinate of the aligned box.
	 * @param miny is the y-coordinate of the lowest coordinate of the aligned box.
	 * @param minz is the z-coordinate of the lowest coordinate of the aligned box.
	 * @param maxx is the x-coordinate of the highest coordinate of the aligned box.
	 * @param maxy is the y-coordinate of the highest coordinate of the aligned box.
	 * @param maxz is the z-coordinate of the highest coordinate of the aligned box.
	...
	/** Compute the farthest point on the aligned box from the given point.
	 *
	 * @param minx is the x-coordinate of the lowest coordinate of the aligned box.
	 * @param miny is the y-coordinate of the lowest coordinate of the aligned box.
	 * @param minz is the z-coordinate of the lowest coordinate of the aligned box.
	...
	/** Replies the points on the bounds of the aligned box.
	 *
	 * @param startingBorder is the first border to reply.
	 * @return the points on the bounds of the aligned box.
	 */
	@Pure
	...
	/** Iterates on points on the sides of a aligned box.
	 *
	 * @param <P> type of the points.
	 * @param <V> type of the vectors.
	 * @param <Q> type of the quaternions.
	 * @author $Author: sgalland$
	 * @version $FullVersion$
	 * @mavengroupid $GroupId$
	 * @mavenartifactid $ArtifactId$
	 * @since 13.0
	 */
	class AlignedBoxSideIterator<P extends Point3D<? super P, ? super V, ? super Q>,
			V extends Vector3D<? super V, ? super P, ? super Q>,
