...
/** A rectangle, aligned on the global axes, with 2 double precision floating-point numbers.
 *
 ...
 * @since 13.0
 */
public class AlignedBox3d extends AbstractShape3d<AlignedBox3d>
	implements AlignedBox3afp<Shape3d<?>, AlignedBox3d, PathElement3d, Point3d, Vector3d, Quaternion4d, AlignedBox3d> {
     ...
     */
	public AlignedBox3d(double x, double y, double z, double width, double height, double depth) {
		setFromCorners(x, y, z, x + width, y + height, z + depth);
	}

	/** Constructor by copy.
     * @param AlignedBox the rectangular prism to copy.
     */
	public AlignedBox3d(AlignedBox3d AlignedBox) {
		set(AlignedBox);
	}
