 ...
 * @since 13.0
 */
public class InnerComputationPoint3afp implements Point3D<InnerComputationPoint3afp, InnerComputationVector3afp, InnerComputationQuaternionafp> {
	...
	@Override
	public UnmodifiablePoint3D<InnerComputationPoint3afp, InnerComputationVector3afp, InnerComputationQuaternionafp> toUnmodifiable() {
