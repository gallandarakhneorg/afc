 ...
 * @since 13.0
 */
public class AlignedBox3i extends AbstractShape3i<AlignedBox3i>
	implements AlignedBox3ai<Shape3i<?>, AlignedBox3i, PathElement3i, Point3i, Vector3i, Quaternion4i, AlignedBox3i> {
	 ...
	 */
	public AlignedBox3i(Point3D<?, ?, ?> min, Point3D<?, ?, ?> max) {
     ...
     */
	public AlignedBox3i(int x, int y, int z, int width, int height, int depth) {
	 ...
	 */
	public AlignedBox3i(AlignedBox3i rectangle) {
		set(rectangle);
	}
