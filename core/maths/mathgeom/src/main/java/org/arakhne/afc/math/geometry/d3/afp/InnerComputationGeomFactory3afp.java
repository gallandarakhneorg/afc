 ...
 * @since 13.0
 */
public final class InnerComputationGeomFactory3afp
		extends AbstractGeomFactory3D<InnerComputationVector3afp, InnerComputationPoint3afp, InnerComputationQuaternionafp> {
	...
	public InnerComputationPoint3afp convertToPoint(Point3D<?, ?, ?> pt) {
		if (pt instanceof InnerComputationPoint3afp pt0) {
			return pt0;
		}
		final double x;
		final double y;
	...
	public InnerComputationVector3afp convertToVector(Vector3D<?, ?, ?> vector) {
		if (vector instanceof InnerComputationVector3afp vec0) {
			return vec0;
		}
		final double x;
        final double y;
