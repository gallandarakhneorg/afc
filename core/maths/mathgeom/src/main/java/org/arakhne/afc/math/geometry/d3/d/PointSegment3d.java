...
/** A 3D segment/line encapsulating two points with 3 double precision numbers.
 *
 ...
 * @see Segment3d
 */
public class PointSegment3d extends AbstractShape3d<PointSegment3d>
	implements Segment3afp<Shape3d<?>, PointSegment3d, PathElement3d, Point3d, Vector3d, Quaternion4d, AlignedBox3d> {
	 ...
	 */
	public PointSegment3d(Point3D<?, ?, ?> p1, Point3D<?, ?, ?> p2) {
	 ...
	 */
	public PointSegment3d(Segment3afp<?, ?, ?, ?, ?, ?, ?> segment) {
     ...
     * @param segment the segment to copy.
     */
	public PointSegment3d(PointSegment3d segment) {
	    this.p1 = segment.p1;
	    this.p2 = segment.p2;
	}
     ...
     */
	public PointSegment3d(double x1, double y1, double z1, double x2, double y2, double z2) {
	...
	@Pure
	@Override
	public PointSegment3d createTransformedShape(Transform3D transform) {
		...
		transform.transform(point);
		return new PointSegment3d(x1, y1, z1, point.getX(), point.getY(), point.getZ());
	}
