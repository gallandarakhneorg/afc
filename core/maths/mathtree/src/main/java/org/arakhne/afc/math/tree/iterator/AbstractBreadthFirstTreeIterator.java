 ...
 */
public abstract class AbstractBreadthFirstTreeIterator<P extends IterableNode<? extends C>, C extends IterableNode<?>>
	...
	private BreadthFirstIterationListener levelListener;

	/** Create an iterator on the given node.
	 *
	 * @param node is the node to iterate.
	 */
	public AbstractBreadthFirstTreeIterator(P node) {
		if (node != null) {
	 ...
	 */
	public void setBreadthFirstIterationListener(BreadthFirstIterationListener listener) {
	 ...
	 */
	@Pure
	public BreadthFirstIterationListener getBreadthFirstIterationListener() {
		return this.levelListener;
	}

	/** Invoked when a row of tree nodes was completely replied by the iterator.
	 */
	protected void onBreadthFirstIterationLevelFinished() {
		if (this.levelListener != null) {
			this.levelListener.onBreadthFirstIterationLevelFinished();
		}
	}
