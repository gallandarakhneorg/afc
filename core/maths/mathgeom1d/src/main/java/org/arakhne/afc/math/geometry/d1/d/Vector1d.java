 ...
 * @since 14.0
 */
public class Vector1d extends Tuple1d<Vector1d, Vector1d, Point1d, Segment1D<?, ?>>
		implements Vector1D<Vector1d, Point1d, Segment1D<?, ?>> {

	private static final long serialVersionUID = 3808635780214517255L;
