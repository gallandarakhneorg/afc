 ...
 * @since 14.0
 */
public class Point1d extends Tuple1d<Point1d, Vector1d, Point1d, Segment1D<?, ?>>
		implements Point1D<Point1d, Vector1d, Segment1D<?, ?>> {

	private static final long serialVersionUID = 7908290495114906962L;
