...
@DisplayName("InnerComputationVector2D")
@SuppressWarnings("all")
public class InnerComputationVector2DTest extends AbstractVector2DTestCase<InnerComputationVector2D, InnerComputationPoint2D, Vector2D> {
