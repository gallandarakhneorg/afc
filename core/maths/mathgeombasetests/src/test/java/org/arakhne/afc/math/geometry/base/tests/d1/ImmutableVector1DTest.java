...
@DisplayName("ImmutableVector1D")
@SuppressWarnings("all")
public class ImmutableVector1DTest extends AbstractMathTestCase {

	private Segment1DStub segment;

	private ImmutableVector1D<Segment1DStub> vector;
	
	@BeforeEach
	public void setUp() {
		this.segment = new Segment1DStub();
		this.vector = new ImmutableVector1D<Segment1DStub>(this.segment, 145.669, 4853.1456);
	}
	...
	public void getGeomFactory() {
		...
		assertSame(ImmutableGeomFactory1D.SINGLETON, this.vector.getGeomFactory());
	}
