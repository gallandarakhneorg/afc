...
/**
 * Test comparator of Tuple3D on their integer coordinates.
 *
 ...
 */
@DisplayName("Tuple3DComparator")
@SuppressWarnings("all")
public class Tuple3DComparatorTest extends AbstractMathTestCase {

	private Tuple3DComparator comparator;

	@BeforeEach
	public void setUp() {
		this.comparator = new Tuple3DComparator();
	}
	...
	@Test
	@DisplayName("null <=> (0,0,0)")
	public void compare_1() {
		var b = new InnerComputationVector3D(0., 0., 0.);
		assertStrictlyNegative(this.comparator.compare(null, b));
	}

	@Test
	@DisplayName("(0,0,0) <=> null")
	public void compare_2() {
		var a = new InnerComputationVector3D(0., 0., 0.);
	...
	@Test
	@DisplayName("(-5,0,0) <=> (0,0,0)")
	public void compare_4() {
		var a = new InnerComputationVector3D(-5., 0., 0.);
		var b = new InnerComputationVector3D(0., 0., 0.);
	...
	@Test
	@DisplayName("(-5,-7,0) <=> (0,0,0)")
	public void compare_6() {
		var a = new InnerComputationVector3D(-5., -7., 0.);
		var b = new InnerComputationVector3D(0., 0., 0.);
		assertStrictlyNegative(this.comparator.compare(a, b));
	}

	@Test
	@DisplayName("(-5,18,0) <=> (0,0,0)")
	public void compare_7() {
		var a = new InnerComputationVector3D(-5., 18., 0.);
		var b = new InnerComputationVector3D(0., 0., 0.);
		assertStrictlyNegative(this.comparator.compare(a, b));
	}
	...
	@Test
	@DisplayName("(0,-7,0) <=> (0,0,0)")
	public void compare_10() {
		var a = new InnerComputationVector3D(0., -7., 0.);
		var b = new InnerComputationVector3D(0., 0., 0.);
		assertStrictlyNegative(this.comparator.compare(a, b));
	}

	@Test
	@DisplayName("(0,18,0) <=> (0,0,0)")
	public void compare_11() {
		var a = new InnerComputationVector3D(0., 18., 0.);
		var b = new InnerComputationVector3D(0., 0., 0.);
		assertStrictlyPositive(this.comparator.compare(a, b));
	}
