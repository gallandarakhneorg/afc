...
@DisplayName("InnerComputationPoint2D")
@SuppressWarnings("all")
public class InnerComputationPoint2DTest extends AbstractPoint2DTestCase<InnerComputationPoint2D, InnerComputationVector2D, Point2D> {
