...
public class Point1DStub implements Point1D<Point1DStub, Vector1DStub, Segment1DStub> {
	...
	public Point1DStub(Segment1DStub segment) {
		this.x = 0.;
		this.y = 0.;
		this.segment = segment;
	}
	
	public Point1DStub(double x, double y, Segment1DStub segment) {
		this.x = x;
		this.y = y;
		this.segment = segment;
	}
	...
	@Override
	public Point1DStub clone() {
		try {
			return (Point1DStub) super.clone();
	...
	@Override
	public UnmodifiablePoint1D<?, ?, Segment1DStub> toUnmodifiable() {
		return new ImmutablePoint1D<Segment1DStub>(this.segment, this.x, this.y);
	}
