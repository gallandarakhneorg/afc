...
public class Vector3f extends Tuple3f<Vector3D> implements Vector3D {
	...
	public final Vector3f mul(Matrix3f m) {
		...
		r.x = (double) (this.getX() * m.m00 + this.getY() * m.m01 + this.getZ() * m.m02);
		r.y = (double) (this.getX() * m.m10 + this.getY() * m.m11 + this.getZ() * m.m12);
		r.z = (double) (this.getX() * m.m20 + this.getY() * m.m21 + this.getZ() * m.m22);
		return r;
	}
