...
public abstract class AbstractRoundRectangle2F<T extends AbstractRectangularShape2F<T>> extends AbstractRectangularShape2F<T> {
	...
	private static class CopyPathIterator2f implements PathIterator2f {
		 ...
		 * @param ah1
		 */
		public CopyPathIterator2f(double x1, double y1, double w1, double h1, double aw1, double ah1) {
			this.x = x1;
			this.y = y1;
	...
	private static class CopyPathIterator2d implements PathIterator2d {
		 ...
		 * @param ah1
		 */
		public CopyPathIterator2d(double x1, double y1, double w1, double h1, double aw1, double ah1) {
			this.x = x1;
			this.y = y1;
			this.w = Math.max(0f, w1);
			this.h = Math.max(0f, h1);
	...
	private static class TransformPathIterator2f implements PathIterator2f {
		 ...
		 * @param transform1
		 */
		public TransformPathIterator2f(double x1, double y1, double w1, double h1, double aw1, double ah1, Transform2D transform1) {
	...
	private static class TransformPathIterator2d implements PathIterator2d {
		 ...
		 * @param transform1
		 */
		public TransformPathIterator2d(double x1, double y1, double w1, double h1, double aw1, double ah1, Transform2D transform1) {
			this.transform = transform1;
			this.x = x1;
			this.y = y1;
			this.w = Math.max(0f, w1);
