...
public interface Parallelogram2afp<
	...
	static boolean containsParallelogramPoint(
		...
		assert Vector2D.isUnitVector(axis2X, axis2Y) :  AXIS_2_NOT_UNIT_VECTOR; //$NON-NLS-1$
	...
	static boolean containsParallelogramRectangle(
		...
		assert Vector2D.isUnitVector(axis1X, axis1Y) :  AXIS_1_NOT_UNIT_VECTOR; //$NON-NLS-1$
		assert Vector2D.isUnitVector(axis2X, axis2Y) :  AXIS_2_NOT_UNIT_VECTOR; //$NON-NLS-1$
		assert rwidth >= 0 :  RECTANGLE_WIDTH; //$NON-NLS-1$
	...
	static boolean intersectsParallelogramEllipse(
		...
		assert Vector2D.isUnitVector(axis1X, axis1Y) :  AXIS_1_NOT_UNIT_VECTOR; //$NON-NLS-1$
		assert Vector2D.isUnitVector(axis2X, axis2Y) :  AXIS_2_NOT_UNIT_VECTOR; //$NON-NLS-1$
		assert ewidth >= 0 :  RECTANGLE_WIDTH; //$NON-NLS-1$
