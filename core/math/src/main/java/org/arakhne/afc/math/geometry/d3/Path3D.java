...
public interface Path3D<
     ...
     */
    void arcTo(Point3D<?, ?> ctrl, Point3D<?, ?> to, double tfrom, double tto, ArcType type);
     ...
     * @param to the target point.
     */
    default void arcTo(Point3D<?, ?> ctrl, Point3D<?, ?> to) {
     ...
     */
    void arcTo(Point3D<?, ?> to, Vector3D<?, ?> radii, double xAxisRotation, boolean largeArcFlag, boolean sweepFlag);
