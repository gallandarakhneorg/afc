 ...
 */
package org.arakhne.afc.math.geometry.continuous.object3d.plane;
 ...
 */
public enum PlanarClassificationType {
	 ...
	 */
	public static PlanarClassificationType invert(PlanarClassificationType t) {
		switch (t) {
		case IN_FRONT_OF:
	 ...
	 */
	public static PlanarClassificationType or(PlanarClassificationType f1, PlanarClassificationType f2) {
		if (f1==f2) return f1;
	 ...
	 * @return the classification of E against the whole object composed of F1 and F2.
	 */
	public PlanarClassificationType or(PlanarClassificationType f2) {
		return or(this,f2);
	}
	 ...
	 */
	public static PlanarClassificationType and(PlanarClassificationType f1, PlanarClassificationType f2) {
		if (f1==f2) return f1;
		return COINCIDENT;
	}
	 ...
	 * @return the result of the intersection.
	 */
	public PlanarClassificationType and(PlanarClassificationType f2) {
		return and(this,f2);
	}
