...
public class Rectangle2f extends AbstractRectangularShape2f<Rectangle2f> {
	...
	public static boolean intersectsRectangleLine(double x1, double y1, double x2, double y2, double x3, double y3, double x4, double y4) {
		int a, b;
		a = Segment2f.ccw(x3, y3, x4, y4, x1, y1, 0.);
		b = Segment2f.ccw(x3, y3, x4, y4, x2, y1, 0.);
		if (a!=b && b!=0) return true;
		b = Segment2f.ccw(x3, y3, x4, y4, x2, y2, 0.);
		if (a!=b && b!=0) return true;
		b = Segment2f.ccw(x3, y3, x4, y4, x1, y2, 0.);
		return (a!=b && b!=0);
	}
	...
	public boolean intersects(OrientedRectangle2f s) {
		return OrientedRectangle2f.intersectsOrientedRectangleRectangle(
