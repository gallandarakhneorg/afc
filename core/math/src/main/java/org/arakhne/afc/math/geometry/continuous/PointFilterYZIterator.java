 ...
 */
public class PointFilterYZIterator
implements Iterator<Point2f> {

	private final Iterator<? extends Tuple3f> original;
	
	/**
	 * @param points are the points to iterate on.
	 */
	public PointFilterYZIterator(Iterator<? extends Tuple3f> points) {
		assert(points!=null);
