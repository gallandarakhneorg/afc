...
class ClosestPointPathShadow2afp {
    ...
    private final Point2D<?, ?> otherShapeClosestPoint_ = new InnerComputationPoint2afp();
    ...
    private void discretizePathIterator(
        ...
        while (pi.hasNext()) {
            ...
            case LINE_TO:
                ...
                if (distance <= 0.) {
                    this.otherShapeClosestPoint_.set(this.temporaryPoint1);
    ...
    public Point2D<?, ?> getClosestPointInOtherShape() {
        return this.otherShapeClosestPoint_;
    }
