...
public class Triangle2fp
	 ...
	 * @param y3
	 */
	public Triangle2fp(double x1, double y1, double x2, double y2, double x3, double y3) {
	...
	@Pure
	@Override
	public Triangle2fp createTransformedShape(Transform2D transform) {
		...
		transform.transform(point);
		return new Triangle2fp(x1, y1, x2, y2, point.getX(), point.getY());
	}
