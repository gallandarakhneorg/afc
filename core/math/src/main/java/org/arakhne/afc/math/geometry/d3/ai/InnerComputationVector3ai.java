 ...
 * @since 13.0
 */
public class InnerComputationVector3ai implements Vector2D<InnerComputationVector3ai, InnerComputationPoint3ai> {
	 ...
	 * @param y
	 */
	public InnerComputationVector3ai(int x, int y) {
		this.x = x;
		this.y = y;
	}
	...
	@Override
	public InnerComputationVector3ai toOrthogonalVector() {
		return null;
	}
	...
	@Override
	public UnmodifiableVector2D<InnerComputationVector3ai, InnerComputationPoint3ai> toUnmodifiable() {
		throw new UnsupportedOperationException();
	}
