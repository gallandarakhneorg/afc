 ...
 */
package org.arakhne.afc.math.geometry.discrete.object2d;
...
public class Segment2i extends AbstractShape2i<Segment2i> {
	...
	public static boolean intersectsSegmentSegment(int x1, int y1, int x2, int y2, int x3, int y3, int x4, int y4) {
		int side1 = GeometryUtil.getPointSideOfLine(x1, y1, x2, y2, x3, y3, false);
		int side2 = GeometryUtil.getPointSideOfLine(x1, y1, x2, y2, x4, y4, false);
		if ((side1*side2)<=0) {
