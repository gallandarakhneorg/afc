...
public class Segment2f extends AbstractShape2f<Segment2f> {
	...
	public static Point2f computeClosestPointTo(
			double ax, double ay, double bx, double by, double px, double py) {
		double ratio = Segment2f.computeProjectedPointOnLine(px, py,
				ax, ay,
				bx, by);
	...
	public double distanceL1(Point2D p) {
		double ratio = Segment2f.computeProjectedPointOnLine(p.getX(), p.getY(), this.ax, this.ay, this.bx, this.by);
