...
public class FileSystemTest {
	...
	private final static File f1 = new File("/home/test.x.z.z"); 
	private final static File f2 = new File("/home"); 
	...
	private final static String TEST_URL1 = "http://toto:titi@www.arakhne.org/path/to/file.x.z.z?toto#frag"; 
	private final static String JOIN_TEST_URL1 = "http://toto:titi@www.arakhne.org/path/to/file.x.z.z/home/test.x.z.z?toto#frag"; 
	private final static String PARENT_TEST_URL1 = "http://toto:titi@www.arakhne.org/path/to/"; 
	private final static String WOEXT_TEST_URL1 = "http://toto:titi@www.arakhne.org/path/to/file.x.z?toto#frag"; 
	private final static String REPEXT_TEST_URL1 = "http://toto:titi@www.arakhne.org/path/to/file.x.z.toto?toto#frag"; 
	private final static String TEST_URL2 = "jar:file:/home/test/j.jar!/org/arakhne/afc/vmutil/file.x.z.z"; 
	private final static String PARENT_TEST_URL2 = "jar:file:/home/test/j.jar!/org/arakhne/afc/vmutil/"; 
	private final static String JOIN_TEST_URL2 = "jar:file:/home/test/j.jar!/org/arakhne/afc/vmutil/file.x.z.z/home/test.x.z.z"; 
	private final static String WOEXT_TEST_URL2 = "jar:file:/home/test/j.jar!/org/arakhne/afc/vmutil/file.x.z"; 
	private final static String REPEXT_TEST_URL2 = "jar:file:/home/test/j.jar!/org/arakhne/afc/vmutil/file.x.z.toto"; 
	private final static String JARPART_TEST_URL2 = "file:/home/test/j.jar"; 
	private final static File f3 = new File("/home/test/j.jar"); 
	private final static File f4 = new File("/org/arakhne/afc/vmutil/file.x.z.z"); 
	private final static String TEST_URL3 = "jar:jar:http://www.arakhne.org/j.jar!/inner/myjar.jar!/org/arakhne/afc/vmutil/file.x.z.z"; 
	private final static String PARENT_TEST_URL3 = "jar:jar:http://www.arakhne.org/j.jar!/inner/myjar.jar!/org/arakhne/afc/vmutil/"; 
	private final static String JARPART_TEST_URL3 = "jar:http://www.arakhne.org/j.jar!/inner/myjar.jar"; 
	private final static String JOIN_TEST_URL3 = "jar:jar:http://www.arakhne.org/j.jar!/inner/myjar.jar!/org/arakhne/afc/vmutil/file.x.z.z/home/test.x.z.z"; 
	private final static String JARJAR_TEST_URL1 = "jar:file:/home/test/j.jar!/inner/myjar.jar"; 
	private final static String JARJAR_TEST_URL2 = "/org/arakhne/afc/vmutil/file.x.z.z/home/test.x.z.z"; 
	private final static String JARJAR_TEST_URL3 = "jar:jar:file:/home/test/j.jar!/inner/myjar.jar!/org/arakhne/afc/vmutil/file.x.z.z/home/test.x.z.z"; 

	private final static String STRING_WITH_SPACE = "/the path/to/file with space.toto"; 
	...
	public void isJarURLURL() throws Exception {
		...
		assertFalse(FileSystem.isJarURL(new URL("file:"+STRING_WITH_SPACE)));  
	...
	public void getJarURLURL() throws Exception {
		...
		assertEquals(new URL("file:"+STRING_WITH_SPACE),  
				FileSystem.getJarURL(new URL("jar:file:"+STRING_WITH_SPACE+"!/titi")));  
