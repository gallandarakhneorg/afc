 ...
 * @since 14.0
 */
public class DTDBasedZippedXMLMagicNumber extends ZippedXMLMagicNumber {
	 ...
	 */
	public DTDBasedZippedXMLMagicNumber(MimeType mimeType, String systemId, String publicId) {
		super(mimeType, null);
	 ...
	 * @param publicId is the DTD system ID associated to this magic number.
	 */
	public DTDBasedZippedXMLMagicNumber(MimeType mimeType, String formatVersion, String systemId, String publicId) {
