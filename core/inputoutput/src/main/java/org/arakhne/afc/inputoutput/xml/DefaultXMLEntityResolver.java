...
public class DefaultXMLEntityResolver implements EntityResolver {
	...
	/** Constructor.
	 * @param assumeEmptyExternalResource if {@code true} this entity resolver
	 *     replies an empty input source when it can't find an external resource. If {@code false}
