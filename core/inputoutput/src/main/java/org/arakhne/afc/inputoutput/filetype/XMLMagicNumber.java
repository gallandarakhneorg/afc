 ...
 *
 * <p>This magic number supports XML files.
 *
...
public abstract class XMLMagicNumber extends MagicNumber {
	 ...
	 */
	public XMLMagicNumber(MimeType mimeType, String rootNode) {
		super(mimeType, MimeName.MIME_XML.toMimeType());
	 ...
	 */
	public XMLMagicNumber(MimeType mimeType, String rootNode, String formatVersion) {
		super(mimeType, formatVersion, MimeName.MIME_XML.toMimeType());
		this.rootNode = rootNode;
	}
